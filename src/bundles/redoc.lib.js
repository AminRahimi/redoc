        ...
        var _ = (e => (
          ...
          q = (e, t, r) =>
            t in e
              ...
              : (e[t] = r),
          B = (e, t) => {
            for (var r in t || (t = {})) M.call(t, r) && q(e, r, t[r]);
            if (N) for (var r of N(t)) F.call(t, r) && q(e, r, t[r]);
            return e;
          };
        function Q(e, t) {
          ...
          render() {
            return this.state.error
              ? e.createElement(
                  ...
                  e.createElement('small', null, ' Commit: ', 'eff730ba'),
                )
...
`;
        ...
        function ye(e) {
          return (
            ...
            (n = function* () {
              ...
              return void 0 !== o.swagger ? ge(o) : o;
            }),
            new Promise((e, r) => {
              var o = e => {
                  try {
            ...
            void 0 === e
              ? $(
                  (() => {
                    ...
                    return e.endsWith('.html') ? (0, Oe.dirname)(e) : e;
                  })(),
                )
              : (0, Oe.dirname)(e);
          return (
        ...
        function bt(e, t) {
          return Object.keys(e)
            .filter(e =>
              !0 === t ? e.startsWith('x-') && !gt(e) : e.startsWith('x-') && t.indexOf(e) > -1,
            )
        ...
        ((e, t, r, n) => {
          for (var o, i = Ft(t, r), s = e.length - 1; s >= 0; s--)
            (o = e[s]) && (i = o(t, r, i) || i);
          i && Mt(t, r, i);
        ...
        class Rr {
          constructor(e) {
            (this.options = e || Vt),
              (this.options.renderer = this.options.renderer || new Er()),
          ...
          (jr.use = function (...e) {
            ...
            e.forEach(e => {
              if (
                ...
                const r = jr.defaults.renderer || new Er();
        ...
        var Cr = Object.defineProperty,
          ...
          Dr = (e, t, r) =>
            t in e
              ...
              : (e[t] = r),
          Lr = (e, t) => {
            for (var r in t || (t = {})) Tr.call(t, r) && Dr(e, r, t[r]);
            if (Ir) for (var r of Ir(t)) _r.call(t, r) && Dr(e, r, t[r]);
            return e;
          };
        const zr = new jr.Renderer();
        jr.setOptions({ renderer: zr, highlight: (e, t) => Ot(e, t) });
        const Nr = '^ {0,3}\x3c!-- ReDoc-Inject:\\s+?<({component}).*?/?>\\s+?--\x3e\\s*$',
          Mr =
        ...
        class Br {
          ...
          static containsComponent(e, t) {
            return new RegExp(Fr.replace(/{component}/g, t), 'gmi').test(e);
          }
          ...
          renderMdWithComponents(e) {
            ...
            const r = Object.keys(t).join('|'),
              n = new RegExp(Fr.replace(/{component}/g, r), 'mig'),
              o = [],
              i = [];
            let s = n.exec(e),
              a = 0;
        ...
        var un = Object.defineProperty,
          ...
          bn = (e, t) => {
            ...
            if (mn) for (var r of mn(t)) yn.call(t, r) && gn(e, r, t[r]);
            return e;
          },
          xn = (e, t) => dn(e, hn(t)),
          vn = (e, t) => {
            ...
            if (null != e && mn)
              for (var n of mn(e)) t.indexOf(n) < 0 && yn.call(e, n) && (r[n] = e[n]);
            return r;
          };
        function wn(e, t) {
            ...
            if (
              ...
              if ((p.if && p.then) || (p.if && p.else)) this.initConditionalOperators(p, e);
                ...
                if (this.hasType('object'))
                  this.fields = zn(e, p, this.pointer, this.options, this.refsStack);
                else if (
                  this.hasType('array') &&
          ...
          initDiscriminator(e, t) {
            ...
            0 !== c.length &&
              ...
              (this.oneOf = l.map(({ $ref: e, name: r }) => {
                const n = new Dn(t, { $ref: e }, e, this.options, !0, this.refsStack.slice(0, -1));
                return (n.title = r), n;
              }));
          }
        ...
        class Wn {
          constructor(e, t, r, n, o) {
            ...
            if (
              ...
              this.examples = P(t) ? t : h(t, (t, r) => new Fn(e, t, r, p.encoding));
            }
            d
              ...
              (this.const =
                ...
                ''),
              (this.descriptionClass = p.descriptionClass || '');
          }
          toggle() {
            this.expanded = !this.expanded;
          }
        ...
        class Hn {
          constructor(e, t, r, n, o) {
            (this.name = t),
              ...
              void 0 !== n.examples
                ? (this.examples = h(n.examples, r => new Fn(e, r, t, n.encoding)))
                : void 0 !== n.example
                ? (this.examples = {
                    default: new Fn(e, { value: e.deref(n.example).resolved }, t, n.encoding),
                  })
            ...
            if (this.schema && this.schema.oneOf) {
              ...
              for (const n of this.schema.oneOf) {
                ...
                this.schema.discriminatorProp &&
                  ...
                  (this.examples[n.title] = new Fn(e, { value: o }, this.name, t.encoding));
              }
            } else
              this.schema &&
                (this.examples = {
        ...
        class lo {
          constructor({
            ...
            void 0 !== a &&
              ...
              (this.descriptionClass = s.descriptionClass || '');
          }
          toggle() {
            this.expanded = !this.expanded;
          }
        ...
        class fo {
          ...
          get responses() {
            ...
            return Object.keys(this.operationSpec.responses || [])
              .filter(t => 'default' === t || ('success' === Le(t) && (e = !0), De(t)))
              .map(
                t =>
                  new lo({
                    parser: this.parser,
        ...
        uo([de.observable], fo.prototype, 'ready', 2),
          ...
          uo([zt], fo.prototype, 'requestBody', 1),
          uo([zt], fo.prototype, 'codeSamples', 1),
          uo([zt], fo.prototype, 'parameters', 1),
          uo([zt], fo.prototype, 'responses', 1),
          uo([zt], fo.prototype, 'callbacks', 1);
          ...
          initWebhooks(e, t, r) {
            for (const o of Object.keys(t)) {
              ...
              for (const t of s) {
                ...
                if (!o) continue;
                const s = new fo(e, ((n = Oo({}, o)), go(n, bo({ httpVerb: t }))), void 0, r, !1);
        ...
        class To {
          constructor(e, t, r) {
            ...
            this.webhooks = new Eo(this.parser, r, s);
          }
        }
        var _o = Object.defineProperty,
          Do = Object.getOwnPropertyDescriptor,
          Lo = (e, t, r, n) => {
            for (var o, i = n > 1 ? void 0 : n ? Do(t, r) : t, s = e.length - 1; s >= 0; s--)
              (o = e[s]) && (i = (n ? o(t, r, i) : o(i)) || i);
        ...
        Lo([de.observable], zo.prototype, 'active', 2),
          Lo([de.observable], zo.prototype, 'expanded', 2),
          Lo([de.action], zo.prototype, 'activate', 1),
          Lo([de.action], zo.prototype, 'expand', 1),
          Lo([de.action], zo.prototype, 'collapse', 1),
          Lo([de.action], zo.prototype, 'deactivate', 1);
        var No = Object.defineProperty,
          ...
          Uo = (e, t, r) =>
            t in e
              ? No(e, t, { enumerable: !0, configurable: !0, writable: !0, value: r })
              : (e[t] = r),
          Wo = (e, t) => {
            for (var r in t || (t = {})) Bo.call(t, r) && Uo(e, r, t[r]);
            if (qo) for (var r of qo(t)) Qo.call(t, r) && Uo(e, r, t[r]);
            return e;
          },
          Vo = (e, t) => Mo(e, Fo(t));
        const Ho = 0;
        class Jo {
          ...
          static getTagsItems(e, t, r, n, o) {
            ...
            return o.sortTagsAlphabetically && a.sort(Nt('name')), a;
          }
          static getOperationsItems(e, t, r, n, o) {
            ...
            return o.sortOperationsAlphabetically && i.sort(Nt('name')), i;
          }
        ...
        ((e, t, r, n) => {
          for (var o, i = ti(t, r), s = e.length - 1; s >= 0; s--)
            (o = e[s]) && (i = o(t, r, i) || i);
          i && ei(t, r, i);
        })([be.bind, Et(100)], ni.prototype, 'handleScroll');
        class oi {
          constructor() {
...
`),
  ...
  ${te('UnderlinedHeader')};
`,
          yi = (0, e.createContext)(void 0),
          { Provider: gi, Consumer: bi } = yi;
        function xi(t) {
...
`;
        ...
        const Ei = { left: '90deg', right: '-90deg', up: '-180deg', down: '0' },
          Si = ee(t =>
            e.createElement(
              'svg',
              {
...
`;
        var Hi = require('perfect-scrollbar'),
          Ji = r.n(Hi),
        ...
        s &&
          ((ts = r(433)),
          (ts = ('function' == typeof ts.toString && ts.toString()) || ''),
          (ts = '[object Object]' === ts ? '' : ts));
        const rs = Z`${ts}`,
          ns = ee.div`
  position: relative;
`;
        class os extends e.Component {
          ...
          componentDidMount() {
            ...
            (this.inst = new es(this._container, this.props.options || {})),
          ...
          return e.createElement(ce.Consumer, null, r =>
            r.nativeScrollbars
              ...
              : e.createElement(
                  os,
                  ((e, t) => {
                    for (var r in t || (t = {})) Gi.call(t, r) && Ki(e, r, t[r]);
                    if (Zi) for (var r of Zi(t)) Xi.call(t, r) && Ki(e, r, t[r]);
                    return e;
                  })({}, t),
                  t.children,
                ),
        ...
        const ss = ee(({ className: t, style: r }) =>
            e.createElement(
              'svg',
              {
                className: t,
...
`;
        var us = Object.defineProperty,
          ...
          fs = (e, t, r) =>
            t in e
              ? us(e, t, { enumerable: !0, configurable: !0, writable: !0, value: r })
              : (e[t] = r);
        function ys(t) {
          const { Label: r = ps, Dropdown: n = cs } = t;
          return 1 === t.options.length
            ? e.createElement(r, null, t.options[0].value)
            : e.createElement(
                n,
                ((e, t) => {
                  for (var r in t || (t = {})) hs.call(t, r) && fs(e, r, t[r]);
                  if (ds) for (var r of ds(t)) ms.call(t, r) && fs(e, r, t[r]);
                  return e;
                })({}, t),
              );
        }
        var gs = require('dompurify');
        const bs = Y`
  a {
        ...
        var vs = Object.defineProperty,
          ...
          Es = (e, t, r) =>
            t in e
              ...
              : (e[t] = r);
        const Ss = xs.withComponent('span');
        function $s(t) {
          const r = t.inline ? Ss : xs;
          return e.createElement(ue, null, n => {
            return e.createElement(
              r,
              ((e, t) => {
                for (var r in t || (t = {})) ks.call(t, r) && Es(e, r, t[r]);
                if (ws) for (var r of ws(t)) Os.call(t, r) && Es(e, r, t[r]);
                return e;
              })(
                {
                  className: 'redoc-markdown ' + (t.className || ''),
                  dangerouslySetInnerHTML: {
                    __html: ((o = n.untrustedSpec), (i = t.html), o ? gs.sanitize(i) : i),
                  },
...
`;
            ...
            return e.createElement(
              ...
              t &&
                e.createElement(
                  Cs,
                  null,
                  e.createElement(Ps, null, r),
                  e.createElement(As, null),
        ...
        class Ds {
          ...
          static copyElement(e) {
            Ds.selectElement(e);
            const t = Ds.copySelected();
            return t && Ds.deselect(), t;
          }
          static copyCustom(e) {
          ...
          return t.children({
            renderCopyButton: () =>
              e.createElement(
                ...
                e.createElement(
                  Ts,
                  { title: Ds.isSupported() ? 'Copied' : 'Not supported in your browser', open: r },
                  'Copy',
                ),
              ),
          });
        ...
        function Qs(e, t) {
          ...
          return (
            null == e
              ? (n += qs('null', 'token keyword'))
              : e && e.constructor === Array
              ? (zs++,
                (n += (function (e, t) {
                  const r = zs > t ? 'collapsed' : '';
                  let n = `<button class="collapser" aria-label="${
                      zs > t + 1 ? 'expand' : 'collapse'
                    }"></button>${Bs(
                      '[',
                  ...
                  for (let s = 0; s < i; s++)
                    (o = !0),
                      ...
                      s < i - 1 && (n += ','),
                      (n += '</div></li>');
                  return (n += `</ul>${Bs(']')}`), o || (n = Bs('[ ]')), n;
                })(e, t)),
                zs--)
              : e && e.constructor === Date
              ? (n += qs('"' + e.toISOString() + '"', 'token string'))
              : 'object' === r
              ? (zs++,
                (n += (function (e, t) {
                  const r = zs > t ? 'collapsed' : '',
                  ...
                  for (let a = 0; a < o; a++) {
                    ...
                    (s = !0),
                      ...
                      (i += '<span class="property token string">"' + Ms(l) + '"</span>: '),
                      (i += Qs(e[l], t)),
                      a < o - 1 && (i += Bs(',')),
                      (i += '</div></li>');
                  }
                  return (i += `</ul>${Bs('}')}`), s || (i = Bs('{ }')), i;
                })(e, t)),
                zs--)
              : 'number' === r
              ? (n += qs(e, 'token number'))
              ...
              ? /^(http|https):\/\/[^\s]+$/.test(e)
                ? (n +=
                    ...
                    '</a>' +
                    qs('"', 'token string'))
                : (n += qs('"' + Fs(e) + '"', 'token string'))
              : 'boolean' === r && (n += qs(e, 'token boolean')),
            n
          );
        }
        const Us = Y`
...
`,
          Vs = ee(t => {
                ...
                return e.createElement(
                  ...
                  e.createElement(ce.Consumer, null, r =>
                    e.createElement(Qi, {
                      className: t.className,
                      ref: e => n(e),
                      dangerouslySetInnerHTML: { __html: Ns(t.data, r.jsonSampleExpandLevel) },
                    }),
                  ),
                );
              },
            ...
            return (
              ...
              e.createElement(Ls, { data: t.data }, o)
            );
          })`
  ${Us};
`,
          Hs = t => {
            ...
            return e.createElement(Vi, { dangerouslySetInnerHTML: { __html: Ot(r, n) } });
          },
          Js = t => {
            const { source: r, lang: n } = t;
            return e.createElement(Ls, { data: r }, ({ renderCopyButton: t }) =>
              e.createElement(
                Wi,
                null,
                e.createElement(Ui, null, t()),
                e.createElement(Hs, { lang: n, source: r }),
              ),
            );
          };
        function Ys({ value: t, mimeType: r }) {
          return Qe(r)
            ? e.createElement(Vs, { data: t })
            : ('object' == typeof t && (t = JSON.stringify(t, null, 2)),
              e.createElement(Js, { lang: Xe(r), source: t }));
        }
        function Zs({ example: t, mimeType: r }) {
          return void 0 === t.value && t.externalValueUrl
            ? e.createElement(Gs, { example: t, mimeType: r })
        ...
        class na extends e.Component {
          ...
          render() {
            const { activeIdx: t } = this.state,
              ...
              o = e.createElement(ra, null, 'No sample'),
              i = Object.keys(r);
            ...
            if (i.length > 1) {
              ...
              return e.createElement(
                ...
                e.createElement(
                  ea,
                  null,
                  e.createElement(Ks, null, 'Example'),
                ...
                e.createElement(
                  'div',
                  null,
                  a && e.createElement(Rs, { source: a }),
                  e.createElement(Zs, { example: s, mimeType: n }),
                ),
              );
            }
            {
              ...
              return e.createElement(
                oa,
                null,
                t.description && e.createElement(Rs, { source: t.description }),
                e.createElement(Zs, { example: t, mimeType: n }),
              );
            }
          }
        }
          ...
          render() {
            ...
            return e.createElement(
              ...
              s.map((t, r) => {
                ...
                return e.createElement(e.Fragment, { key: r }, e.createElement(ya, null, n), ' ');
              }),
              a
                ? e.createElement(
                    Oa,
                ...
                r.showExtensions &&
                  Object.keys(t).map(r =>
                    e.createElement(
                      Ea,
                      { key: r },
                      e.createElement(aa, null, ' ', r.substring(2), ': '),
                      ' ',
                      e.createElement(
                        ga,
                        null,
        ...
        function $a({ field: t }) {
          return t.examples
            ? e.createElement(
                e.Fragment,
                null,
                e.createElement(aa, null, ' ', T('examples'), ': '),
                P(t.examples)
                  ? t.examples.map((r, n) => {
                      const o = Ge(t, r),
                  ...
                  : e.createElement(
                      ...
                      Object.values(t.examples).map((r, n) =>
                        e.createElement(
                          'li',
                          { key: n + r.value },
                          e.createElement(ya, null, Ge(t, r.value)),
                          ' -',
                          ' ',
          ...
          render() {
            return 0 === this.props.constraints.length
              ...
              : e.createElement(
                  ...
                  null,
                  ' ',
                  this.props.constraints.map(t =>
                    e.createElement(ba, { key: t, className: 'sar-ConstraintItem' }, ' ', t, ' '),
                  ),
                );
          }
        }
        const Ca = e.memo(function ({ value: t, label: r, raw: n }) {
          if (void 0 === t) return null;
          const o = n ? String(t) : JSON.stringify(t);
          return e.createElement(
            'div',
            null,
            e.createElement(aa, null, ' ', r, ' '),
            ' ',
            e.createElement(ya, { className: 'sar-ExampleValue' }, o),
          );
        });
        function Pa(t) {
          ...
          return !r || n
            ...
            : e.createElement(
                e.Fragment,
                null,
                e.createElement(fa, null, o || r.length < 45 ? r : `${r.substr(0, 45)}...`),
                r.length > 45 &&
                  e.createElement(xa, { onClick: s }, o ? 'Hide pattern' : 'Show pattern'),
              );
        }
        function Aa({ schema: t }) {
          ...
          return t &&
            ...
            ? e.createElement(
                ...
                null,
                '[ items',
                t.displayFormat && e.createElement(ua, null, ' <', t.displayFormat, ' >'),
                e.createElement(ja, { constraints: t.constraints }),
                e.createElement(Pa, { schema: t }),
                t.items && e.createElement(Aa, { schema: t.items }),
                ' ]',
              )
            : null;
        }
...
`;
        var Ta = Object.defineProperty,
          ...
          za = (e, t, r) =>
            t in e
              ? Ta(e, t, { enumerable: !0, configurable: !0, writable: !0, value: r })
              : (e[t] = r),
          Na = (e, t) => {
            for (var r in t || (t = {})) Da.call(t, r) && za(e, r, t[r]);
            if (_a) for (var r of _a(t)) La.call(t, r) && za(e, r, t[r]);
            return e;
          };
        const Ma = (0, ia.observer)(t => {
            ...
            return e.createElement(
              'div',
              { className: 'FieldDetailsDiv' },
              e.createElement(
                'div',
                { className: 'FieldDetailsDiv__childDiv1' },
                e.createElement(la, null, a.typePrefix),
                e.createElement(ca, { className: 'sar-TypeName' }, a.displayType),
                a.displayFormat && e.createElement(ua, null, ' ', '<', a.displayFormat, '>', ' '),
                a.contentEncoding &&
                  e.createElement(ua, null, ' ', '<', a.contentEncoding, '>', ' '),
                a.contentMediaType &&
                  e.createElement(ua, null, ' ', '<', a.contentMediaType, '>', ' '),
                a.title && !n && e.createElement(pa, null, ' (', a.title, ') '),
                e.createElement(ja, { constraints: a.constraints }),
                e.createElement(Pa, { schema: a }),
                a.isCircular && e.createElement(ma, null, ' ', T('recursive'), ' '),
                m && a.items && e.createElement(Aa, { schema: a.items }),
              ),
              p &&
                e.createElement(
                  'div',
                  null,
                  e.createElement($i, { type: 'warning' }, ' ', T('deprecated'), ' '),
                ),
              e.createElement(
                'div',
                { className: 'FieldDetailsDiv__childDiv2' },
                e.createElement(Ca, { raw: f, label: T('default') + ':', value: g }),
              ),
              e.createElement(
                'div',
                { className: 'FieldDetailsDiv__childDiv3' },
                !s && e.createElement(ka, { isArrayType: m, values: a.enum }),
                ' ',
                y,
              ),
              e.createElement(
                'div',
                { className: 'FieldDetailsDiv__childDiv4' },
                e.createElement(Sa, { extensions: Na(Na({}, u), a.extensions) }),
              ),
              e.createElement(
                'div',
                { className: c + ' FieldDetailsDiv__description' },
                e.createElement(Rs, { compact: !0, source: l }),
              ),
              e.createElement(
                'div',
                { className: 'FieldDetailsDiv__childDiv6' },
                a.externalDocs &&
                  e.createElement(wa, { externalDocs: a.externalDocs, compact: !0 }),
                (s && s(t)) || null,
                (h && e.createElement(Ca, { label: T('const') + ':', value: h })) || null,
              ),
            );
          }),
          Fa = e.memo(Ma);
        var qa = Object.defineProperty,
          ...
          Qa = (Object.getOwnPropertyDescriptor, Object.getOwnPropertyDescriptors),
          ...
          Ha = (e, t, r) =>
            t in e
              ...
              : (e[t] = r);
        let Ja = class extends e.Component {
          constructor() {
            super(...arguments),
              (this.toggle = () => {
          ...
          render() {
            const { className: t = '', field: r, isLast: n, expandByDefault: o } = this.props,
              ...
              u = e.createElement(
                e.Fragment,
                null,
                'additionalProperties' === l && e.createElement(ha, null, 'additional property'),
                'patternProperties' === l && e.createElement(ha, null, 'pattern property'),
              ...
              d = c
                ? e.createElement(
                    ...
                    {
                      className: s
                        ? 'deprecated ClickablePropertyNameCell'
                    ...
                    e.createElement(
                      ...
                      e.createElement(Si, { direction: p ? 'down' : 'right' }),
                    ),
                    u,
                  )
                : e.createElement(
            ...
            return e.createElement(
              ...
              e.createElement(
                ...
                e.createElement(
                  Ii,
                  { className: 'PropertyDetailsCell ' + r.name },
                  e.createElement(
                    Fa,
                    ((h = ((e, t) => {
                      for (var r in t || (t = {})) Wa.call(t, r) && Ha(e, r, t[r]);
                      if (Ua) for (var r of Ua(t)) Va.call(t, r) && Ha(e, r, t[r]);
                      return e;
                    })({}, this.props)),
                    Ba(h, Qa({ className: 'FieldDetails' }))),
                  ),
                ),
              ),
              p &&
                ...
                e.createElement(
                  'tr',
                  { key: r.name + 'inner', className: 'sar-tr' },
                  e.createElement(
                    Pi,
                    { colSpan: 2 },
                    e.createElement(
        ...
        var Ga = Object.defineProperty,
          ...
          nl = (e, t, r) =>
            t in e
              ...
              : (e[t] = r),
          ol = (e, t) => {
            for (var r in t || (t = {})) tl.call(t, r) && nl(e, r, t[r]);
            if (el) for (var r of el(t)) rl.call(t, r) && nl(e, r, t[r]);
            return e;
          },
          il = (e, t) => Xa(e, Ka(t));
        const sl = ee.div`
...
`;
        class al extends e.PureComponent {
          render() {
            ...
            return t.fields
              ? e.createElement(Za, il(ol({}, this.props), { level: this.props.level }))
              : !t.displayType || r || n.length
              ? e.createElement(
                  'div',
                  null,
                  e.createElement(Mi, null, ' Array ', n),
                  e.createElement(
                    sl,
                    null,
                    e.createElement(Cl, il(ol({}, this.props), { schema: r })),
                  ),
                  e.createElement(Fi, null),
                )
              : e.createElement('div', null, e.createElement(ca, null, t.displayType));
          }
        }
        var ll = Object.defineProperty,
          ...
          fl = (e, t, r) =>
            t in e
              ...
              : (e[t] = r),
          yl = (e, t, r, n) => {
            for (var o, i = n > 1 ? void 0 : n ? pl(t, r) : t, s = e.length - 1; s >= 0; s--)
              (o = e[s]) && (i = (n ? o(t, r, i) : o(i)) || i);
            return n && i && ll(t, r, i), i;
          };
        let gl = class extends e.Component {
          constructor() {
            super(...arguments),
              (this.activateOneOf = () => {
        ...
        let bl = class extends e.Component {
          render() {
            ...
            return e.createElement(
              'div',
              null,
              e.createElement(zi, null, ' ', r.oneOfType, ' '),
              e.createElement(
                Li,
                null,
                t.map((t, n) =>
                  e.createElement(gl, { key: t.pointer, schema: r, subSchema: t, idx: n }),
                ),
              ),
              e.createElement(
                'div',
                ...
                t[r.activeOneOf].deprecated &&
                  e.createElement($i, { type: 'warning' }, 'Deprecated'),
              ),
              e.createElement(ja, { constraints: n.constraints }),
              e.createElement(
                Cl,
                ((o = ((e, t) => {
                  for (var r in t || (t = {})) hl.call(t, r) && fl(e, r, t[r]);
                  if (dl) for (var r of dl(t)) ml.call(t, r) && fl(e, r, t[r]);
                  return e;
                })({}, this.props)),
                cl(o, ul({ schema: n }))),
              ),
        ...
        bl = yl([ia.observer], bl);
        const xl = (0, ia.observer)(({ schema: t }) =>
          e.createElement(
            'div',
            null,
            e.createElement(ca, null, t.displayType),
            t.title && e.createElement(pa, null, ' ', t.title, ' '),
            e.createElement(ma, null, ' ', T('recursive'), ' '),
          ),
        );
        var vl = Object.defineProperty,
          wl = Object.defineProperties,
          kl = (Object.getOwnPropertyDescriptor, Object.getOwnPropertyDescriptors),
          ...
          $l = (e, t, r) =>
            t in e
              ...
              : (e[t] = r),
          Rl = (e, t) => {
            for (var r in t || (t = {})) El.call(t, r) && $l(e, r, t[r]);
            if (Ol) for (var r of Ol(t)) Sl.call(t, r) && $l(e, r, t[r]);
            return e;
          },
          jl = (e, t) => wl(e, kl(t));
        let Cl = class extends e.Component {
          render() {
            ...
            if (void 0 !== a) return e.createElement(bl, Rl({ schema: n }, o));
            const p = P(s) ? s : [s];
            if (p.includes('object')) {
              if (null == (t = n.fields) ? void 0 : t.length)
                return e.createElement(Za, jl(Rl({}, this.props), { level: i }));
            } else if (p.includes('array'))
              return e.createElement(al, jl(Rl({}, this.props), { level: i }));
            const u = {
              schema: n,
              name: '',
              required: !1,
            ...
            return e.createElement('div', null, e.createElement(Fa, { field: u }));
          }
        };
        Cl = ((e, t, r, n) => {
          for (var o, i = t, s = e.length - 1; s >= 0; s--) (o = e[s]) && (i = o(i) || i);
        ...
        var Pl = Object.defineProperty,
          ...
          Ll = (e, t, r) =>
            t in e
              ...
              : (e[t] = r);
        class zl extends e.PureComponent {
          constructor() {
            super(...arguments),
              (this.renderDropdown = t => {
                return e.createElement(
                  ys,
                  ((r = ((e, t) => {
                    for (var r in t || (t = {})) _l.call(t, r) && Ll(e, r, t[r]);
                    if (Tl) for (var r of Tl(t)) Dl.call(t, r) && Ll(e, r, t[r]);
                    return e;
                  })({ Label: ps, Dropdown: ta }, t)),
                  Al(r, Il({ variant: 'dark' }))),
                );
                var r;
              });
          }
          ...
          get mediaModel() {
            ...
            return (
              this._mediaModel ||
                (this._mediaModel = new Hn(e, 'json', !1, zl.getMediaType(t, r), n)),
              this._mediaModel
            );
          }
          render() {
...
`;
        function Jl({ children: t, height: r }) {
          const n = e.createRef(),
            [o, i] = e.useState(!1),
            [s, a] = e.useState(!1);
          return (
...
`,
            ...
            return e.createElement(
              ...
              !!i.length &&
                e.createElement(
                  ...
                  null,
                  o || null,
                  e.createElement(Vl, null, e.createElement('b', null, ' Scopes: ')),
                  e.createElement(
                    Jl,
                    { height: '4em' },
                    e.createElement(
          ...
          return e.createElement(
            ...
            n.apiKey
              ...
              ? Object.keys(n.flows).map(t =>
                  e.createElement(Xl, { key: t, type: t, RequiredScopes: r, flow: n.flows[t] }),
                )
              : null,
          );
        }
                ...
                e.createElement(
                  ...
                  e.createElement(
                    ...
                    e.createElement(
                      hi,
                      null,
                      e.createElement(Oi, { to: t.sectionId }),
                      t.displayName,
                    ),
                    e.createElement(Rs, { source: t.description || '' }),
                    e.createElement(
                      Hl,
                      null,
                      e.createElement(
        ...
        function nc(e, t) {
          return rc(this, arguments, function* (e, t, r = {}) {
        ...
        class oc {
          ...
          static fromJS(e) {
            const t = new oc(e.spec.data, e.spec.url, e.options, !1);
            return (
...
`;
        Object.defineProperty, Object.getOwnPropertyDescriptor;
        let uc = class extends e.Component {
          constructor() {
            super(...arguments),
            ...
            return e.createElement(
              ...
              e.createElement(
                ...
                e.createElement(
                  ii,
                  { className: 'api-info' },
                  e.createElement(sc, null, r.title, ' ', u),
                  !o &&
                    e.createElement(
                      'p',
                      null,
                  ...
                  e.createElement(
                    ...
                    ((r.license || r.contact || r.termsOfService) &&
                      e.createElement(
                        cc,
                        null,
                        e.createElement(pc, null, c, ' ', l, ' ', a, ' ', p),
                      )) ||
                      null,
                  ),
                  e.createElement(Rs, {
                  ...
                  n && e.createElement(wa, { externalDocs: n }),
                ),
              ),
            );
          }
...
`;
        Object.defineProperty, Object.getOwnPropertyDescriptor;
        let fc = class extends e.Component {
          render() {
            ...
            const n = r.href || (t.contact && t.contact.url),
              ...
              i = e.createElement(dc, { src: r.url, alt: o });
            return e.createElement(
              hc,
              { style: { backgroundColor: r.backgroundColor } },
              n ? ((s = n), t => e.createElement(mc, { href: s }, t))(i) : i,
            );
            var s;
          }
        };
        ...
        var yc = Object.defineProperty,
          ...
          vc = (e, t, r) =>
            t in e
              ...
              : (e[t] = r),
          wc = (e, t) => {
            for (var r in t || (t = {})) bc.call(t, r) && vc(e, r, t[r]);
            if (gc) for (var r of gc(t)) xc.call(t, r) && vc(e, r, t[r]);
            return e;
          };
        class kc extends e.Component {
          render() {
              ...
              ? i.map((t, n) => {
                  if ('string' == typeof t)
                    return e.cloneElement(
                      o(e.createElement($s, { html: t, inline: !1, compact: !1 })),
                      { key: n },
                    );
                  const i = t.component;
                  return e.createElement(
                    i,
                    wc({ key: n }, wc(wc({}, t.props), t.propsSelector(r))),
                  );
                })
              : null;
          }
        }
        var Oc = require('classnames'),
          Ec = r.n(Oc);
        const Sc = ee.span.attrs(e => ({ className: `operation-type ${e.type}` }))`
  width: 9ex;
  display: inline-block;
...
`,
  ...
  ${e => Cc[e.depth]};
  background-color: ${e =>
    e.active ? $c(e.depth, e, 'activeBackgroundColor') : e.theme.sidebar.backgroundColor};
...
`,
          Lc = ee(t => {
            ...
            return e.createElement(
              ...
              e.createElement(Dc, { type: s }, yt(s)),
              e.createElement(Si, {
                size: '1.5em',
                direction: n ? 'down' : 'right',
                float: 'left',
              }),
              e.createElement(_c, { deprecated: a }, r),
              a ? e.createElement($i, { type: 'warning' }, ' ', T('deprecated'), ' ') : null,
            );
          })`
  padding: 10px;
  border-radius: 2px;
...
`,
  ...
  margin-top: 5px;
`;
        class Nc extends e.PureComponent {
          constructor() {
            super(...arguments),
              (this.selectElement = () => {
                Ds.selectElement(this.child);
              });
          }
          render() {
            ...
            return e.createElement(ce.Consumer, null, i =>
              e.createElement(
                ...
                e.createElement(
                  ...
                  e.createElement(Fc, null, t.path),
                  e.createElement(Si, {
                    float: 'right',
                    color: r ? 'black' : 'white',
                    size: '20px',
                ...
                e.createElement(
                  ...
                  t.servers.map(r => {
                    const o = i.expandDefaultServerVariables ? ct(r.url, r.variables) : r.url,
                      s = E(o);
                    return e.createElement(
                      Uc,
                      { key: o },
                      e.createElement(Rs, { source: r.description || '', compact: !0 }),
                      e.createElement(
                        Nc,
                        null,
                        e.createElement(
              ...
              ? e.createElement(
                  ...
                  e.createElement(
                    ...
                    e.createElement(
                      ...
                      null,
                      d(r, (t, r) =>
                        e.createElement(Ja, { key: t.name, isLast: r, field: t, showExamples: !0 }),
                      ),
                    ),
                  ),
                )
            ...
            const r = t.activeMimeIdx,
              ...
              o = ({ children: t }) =>
                this.props.withLabel
                  ? e.createElement(ea, null, e.createElement(Ks, null, 'Content type'), t)
                  : t;
            return e.createElement(
              e.Fragment,
              null,
        ...
        var Yc = Object.defineProperty,
          ...
          Kc = (e, t, r) =>
            t in e
              ...
              : (e[t] = r),
          ep = (e, t) => {
            for (var r in t || (t = {})) Gc.call(t, r) && Kc(e, r, t[r]);
            if (Zc) for (var r of Zc(t)) Xc.call(t, r) && Kc(e, r, t[r]);
            return e;
          };
        const tp = ['path', 'query', 'cookie', 'header'];
        class rp extends e.PureComponent {
          orderParams(e) {
            const t = {};
            return (
              e.forEach(e => {
          ...
          render() {
            ...
            return e.createElement(
              e.Fragment,
              null,
              o.map(t => e.createElement(Hc, { key: t, place: t, parameters: n[t] })),
              i && e.createElement(op, { content: i, description: s, bodyRequired: a }),
            );
          }
        }
        function np(t) {
          var r = t,
            ...
            o = ((e, t) => {
              var r = {};
              for (var n in e) Gc.call(e, n) && t.indexOf(n) < 0 && (r[n] = e[n]);
              if (null != e && Zc)
                for (var n of Zc(e)) t.indexOf(n) < 0 && Xc.call(e, n) && (r[n] = e[n]);
              return r;
            })(r, ['bodyRequired']);
          ...
          return e.createElement(
            ...
            { key: 'header' },
            'Request Body schema: ',
            e.createElement(ys, ep({}, o)),
            i && e.createElement(sp, null, 'required'),
            s && e.createElement(ap, null, 'optional'),
          );
        }
        function op(t) {
          ...
          return e.createElement(
            Jc,
            { content: r, renderDropdown: t => e.createElement(np, ep({ bodyRequired: o }, t)) },
            ({ schema: t }) =>
              e.createElement(
                e.Fragment,
                null,
                void 0 !== n && e.createElement(Rs, { source: n }),
                'object' === (null == t ? void 0 : t.type) &&
                  e.createElement(ja, { constraints: (null == t ? void 0 : t.constraints) || [] }),
                e.createElement(Cl, {
                  skipReadOnly: i,
                  skipWriteOnly: !i,
                  key: 'schema',
...
`,
          lp = e.memo(function ({
            ...
            return e.createElement(
              'button',
              { className: a, onClick: (!n && l) || void 0, 'aria-expanded': s, disabled: n },
              !n &&
                e.createElement(Si, {
                  size: '1.5em',
                  color: r,
              ...
              e.createElement(dp, null, o, ' '),
              e.createElement(
                'div',
                { className: i + ' ResponseTitleComponent__Markdown' },
                e.createElement(Rs, { compact: !0, inline: !0, source: t }),
              ),
            );
          }),
          cp = ee(lp)`
          ...
          render() {
            ...
            return void 0 === t || 0 === t.length
              ...
              : e.createElement(
                  Di,
                  null,
                  e.createElement(up, null, ' Response Headers '),
                  e.createElement(
                    'tbody',
                    null,
                    d(t, (t, r) =>
                      e.createElement(Ja, { isLast: r, key: t.name, field: t, showExamples: !0 }),
                    ),
                  ),
                );
          }
        ...
        class xp extends e.PureComponent {
          ...
          render() {
            ...
            return e.createElement(
              ...
              e.createElement(
                'span',
                { className: r + ' ResponseDetails__description' },
                t && e.createElement(Rs, { source: t }),
              ),
              e.createElement(Sa, { extensions: n }),
              e.createElement(hp, { headers: o }),
              e.createElement(
                Jc,
                ...
                ({ schema: t }) =>
                  e.createElement(
                    ...
                    e.createElement(Cl, { skipWriteOnly: !0, key: 'schema', schema: t }),
                  ),
              ),
            );
          }
        }
        const vp = (0, ia.observer)(({ response: t }) => {
            const {
                extensions: r,
                headers: n,
                type: o,
              ...
              u = e.useMemo(
                () => (void 0 === p ? [] : p.mediaTypes.filter(e => void 0 !== e.schema)),
                [p],
              ),
              d = e.useMemo(
                () =>
                  !((r && 0 !== Object.keys(r).length) || 0 !== n.length || 0 !== u.length || s),
                [r, n, u, s],
              );
            return e.createElement(
              'div',
              ...
              c && !d && e.createElement(pp, null, e.createElement(xp, { response: t })),
            );
          }),
          wp = ee.h3`
  font-size: 1.3em;
...
`;
        class kp extends e.PureComponent {
          render() {
            ...
            return t && 0 !== t.length
              ? e.createElement(
                  'div',
                  { className: 'ResponsesList' },
                  e.createElement(wp, null, T(r ? 'callbackResponses' : 'responses')),
                  t.map(t => e.createElement(vp, { key: t.code, response: t })),
                )
              : null;
          }
        }
        function Op(t) {
          ...
          return 0 === r.schemes.length
            ? e.createElement(ql, { expanded: o }, 'None')
            : e.createElement(
                ql,
                { expanded: o },
                i && '(',
                r.schemes.map(t =>
                  e.createElement(
                    ...
                    o && t.scopes.length
                      ? [' (', t.scopes.map(t => e.createElement(Ml, { key: t }, t)), ') ']
                      : null,
                  ),
                ),
                i && ') ',
          ...
          return e.createElement(
            ...
            e.createElement(
              ...
              e.createElement(
                Bl,
                { onClick: () => i(!o) },
                e.createElement(Ul, null, 'Authorizations:'),
                e.createElement(Si, { size: '1.3em', direction: o ? 'down' : 'right' }),
              ),
              e.createElement(
                Ql,
                { expanded: o },
              ...
              a.map((t, r) =>
                e.createElement(
                  ...
                  e.createElement(Kl, {
                    key: t.id,
                    scheme: t,
                    RequiredScopes: e.createElement(Ep, { scopes: Rp(t.id, s) }),
                  }),
                ),
              ),
          );
            ...
            return e.createElement(
              ...
              o &&
                e.createElement(
                  Cp,
                  null,
                  void 0 !== r && e.createElement(Rs, { source: r }),
                  n && e.createElement(wa, { externalDocs: n }),
                ),
              e.createElement(Vc, { operation: this.props.operation, inverted: !0, compact: !0 }),
              e.createElement(Sa, { extensions: t.extensions }),
              e.createElement(Sp, { securities: t.security }),
              e.createElement(rp, { parameters: t.parameters, body: t.requestBody }),
              e.createElement(kp, { responses: t.responses, isCallback: t.isCallback }),
            );
          }
        };
        jp = ((e, t, r, n) => {
        ...
        let Pp = class extends e.Component {
          ...
          render() {
            ...
            return e.createElement(
              ...
              r && e.createElement(jp, { operation: this.props.callbackOperation }),
            );
          }
        };
        Pp = ((e, t, r, n) => {
          ...
          render() {
            ...
            return t && 0 !== t.length
              ? e.createElement(
                  'div',
                  null,
                  e.createElement(Ip, null, ' Callbacks '),
                  t.map(t =>
                    t.operations.map((r, n) =>
                      e.createElement(Pp, { key: `${t.name}_${n}`, callbackOperation: r }),
                    ),
                  ),
                )
              : null;
...
`;
        Object.defineProperty, Object.getOwnPropertyDescriptor;
        let Tp = class extends e.Component {
          constructor(e) {
            super(e),
          ...
          render() {
            ...
            const r = ({ children: t }) =>
              this.props.label
                ? e.createElement(ea, null, e.createElement(Ks, null, this.props.label), t)
                : t;
            return e.createElement(
              e.Fragment,
              null,
        ...
        var _p = Object.defineProperty,
          ...
          Lp = (Object.getOwnPropertyDescriptor, Object.getOwnPropertyDescriptors),
          zp = Object.getOwnPropertySymbols,
          Np = Object.prototype.hasOwnProperty,
          Mp = Object.prototype.propertyIsEnumerable,
          Fp = (e, t, r) =>
            t in e
              ? _p(e, t, { enumerable: !0, configurable: !0, writable: !0, value: r })
              : (e[t] = r);
        let qp = class extends e.Component {
          constructor() {
            super(...arguments),
              (this.renderDropdown = t => {
                return e.createElement(
                  ys,
                  ((r = ((e, t) => {
                    for (var r in t || (t = {})) Np.call(t, r) && Fp(e, r, t[r]);
                    if (zp) for (var r of zp(t)) Mp.call(t, r) && Fp(e, r, t[r]);
                    return e;
                  })({ Label: Xs, Dropdown: ta }, t)),
                  Dp(r, Lp({ variant: 'dark' }))),
                );
                var r;
              });
          }
        ...
        class Bp extends e.Component {
          render() {
            const t = this.props.callback.codeSamples.find(e => ho(e));
            return t
              ? e.createElement(Qp, null, e.createElement(qp, { content: t.requestBodyContent }))
              : null;
          }
        }
        const Qp = ee.div`
...
`;
        var Up = Object.defineProperty,
          ...
          Vp = (Object.getOwnPropertyDescriptor, Object.getOwnPropertyDescriptors),
            ...
            super(...arguments),
              (this.renderDropdown = t => {
                return e.createElement(
                  ys,
                  ((r = ((e, t) => {
                    for (var r in t || (t = {})) Jp.call(t, r) && Zp(e, r, t[r]);
                    if (Hp) for (var r of Hp(t)) Yp.call(t, r) && Zp(e, r, t[r]);
                    return e;
                  })({ Label: Xs, Dropdown: ta }, t)),
                  Wp(r, Vp({ variant: 'dark' }))),
                );
                var r;
              });
          }
...
`;
        Object.defineProperty, Object.getOwnPropertyDescriptor;
        let Kp = class extends e.Component {
          render() {
            const { operation: t } = this.props,
              r = t.codeSamples,
              n = r.length > 0,
            ...
            return (
              (n &&
                e.createElement(
                  'div',
                  null,
                  e.createElement(mi, null, ' ', T('requestSamples'), ' '),
                  e.createElement(
                    Bi,
                    { defaultIndex: 0 },
                    e.createElement(
                      ...
                      e.createElement(
                        ...
                        ho(t)
                          ? e.createElement(
                              'div',
                              null,
                              e.createElement(qp, { content: t.requestBodyContent }),
                            )
                          : e.createElement(Js, { lang: t.lang, source: t.source }),
                      ),
                    ),
                  ),
                )) ||
            ...
            return (
              (r.length > 0 &&
                e.createElement(
                  'div',
                  null,
                  e.createElement(mi, null, ' ', T('responseSamples'), ' '),
                  e.createElement(
                    Bi,
                    { defaultIndex: 0 },
                    e.createElement(
                    ...
                    r.map(t =>
                      e.createElement(
                        qi.TabPanel,
                        { key: t.code },
                        e.createElement('div', null, e.createElement(qp, { content: t.content })),
                      ),
                    ),
                  ),
                )) ||
        ...
        var tu = Object.defineProperty,
          ...
          au = (e, t, r) =>
            t in e
              ? tu(e, t, { enumerable: !0, configurable: !0, writable: !0, value: r })
              : (e[t] = r);
        const lu = ee.div`
  margin-bottom: ${({ theme: e }) => 6 * e.spacing.unit}px;
`,
          cu = (0, ia.observer)(({ operation: t }) => {
            const {
                name: r,
                description: n,
                deprecated: o,
            ...
            return e.createElement(ce.Consumer, null, p => {
              return e.createElement(
                ci,
                ((u = ((e, t) => {
                  for (var r in t || (t = {})) iu.call(t, r) && au(e, r, t[r]);
                  if (ou) for (var r of ou(t)) su.call(t, r) && au(e, r, t[r]);
                  return e;
                })({}, { [Xo]: t.operationHash })),
                ...
                e.createElement(
                  ...
                  e.createElement(
                    hi,
                    null,
                    e.createElement(Oi, { to: t.id }),
                    r,
                    ' ',
                    o && e.createElement($i, { type: 'warning' }, ' Deprecated '),
                    s &&
                      e.createElement(
                        $i,
                        { type: 'primary' },
                  ...
                  p.pathInMiddlePanel && !s && e.createElement(Vc, { operation: t, inverted: !0 }),
                  l &&
                    e.createElement(
                      lu,
                      null,
                      void 0 !== n && e.createElement(Rs, { source: n }),
                      i && e.createElement(wa, { externalDocs: i }),
                    ),
                  e.createElement(Sa, { extensions: t.extensions }),
                  e.createElement(Sp, { securities: t.security }),
                  e.createElement(rp, { parameters: t.parameters, body: t.requestBody }),
                  e.createElement(kp, { responses: t.responses }),
                  e.createElement(Ap, { callbacks: t.callbacks }),
                ),
                e.createElement(
                  li,
                  null,
                  !p.pathInMiddlePanel && !s && e.createElement(Vc, { operation: t }),
                  e.createElement(Kp, { operation: t }),
                  e.createElement(eu, { operation: t }),
                  e.createElement(Gp, { callbacks: t.callbacks }),
                ),
              );
              var u, d;
            });
        ...
        var pu = Object.defineProperty,
          ...
          fu = (e, t, r) =>
            t in e
              ...
              : (e[t] = r),
          yu = (e, t, r, n) => {
            for (var o, i = n > 1 ? void 0 : n ? uu(t, r) : t, s = e.length - 1; s >= 0; s--)
              (o = e[s]) && (i = (n ? o(t, r, i) : o(i)) || i);
            return n && i && pu(t, r, i), i;
          };
        let gu = class extends e.Component {
          render() {
            const t = this.props.items;
            return 0 === t.length ? null : t.map(t => e.createElement(bu, { key: t.id, item: t }));
          }
        };
        gu = yu([ia.observer], gu);
          ...
          render() {
            ...
            switch (n) {
              ...
              default:
                ...
                break;
              case 'operation':
                r = e.createElement(wu, { item: t });
            }
            return e.createElement(
              e.Fragment,
              null,
              r && e.createElement(si, { id: t.id, underlined: 'operation' === t.type }, r),
              t.items && e.createElement(gu, { items: t.items }),
            );
          }
        };
        bu = yu([ia.observer], bu);
        const xu = t => e.createElement(ii, { compact: !0 }, t);
        let vu = class extends e.Component {
          render() {
              ...
              e.createElement(
                ...
                e.createElement(
                  ...
                  e.createElement(
                    ...
                    e.createElement(Oi, { to: this.props.item.id }),
                    t,
                  ),
                ),
              ),
              e.createElement(kc, { parentId: this.props.item.id, source: r || '', htmlWrap: xu }),
              n &&
                e.createElement(
                  ci,
                  null,
                  e.createElement(ii, null, e.createElement(wa, { externalDocs: n })),
                ),
            );
          }
        };
        vu = yu([ia.observer], vu);
        let wu = class extends e.Component {
          render() {
            return e.createElement(cu, { operation: this.props.item });
          }
        };
        wu = yu([ia.observer], wu);
        var ku = Object.defineProperty,
          Ou = Object.defineProperties,
          Eu = (Object.getOwnPropertyDescriptor, Object.getOwnPropertyDescriptors),
            ...
            return e.createElement(
              ...
              'operation' === t.type
                ? e.createElement(
                    Pu,
                    ((n = ((e, t) => {
                      for (var r in t || (t = {})) $u.call(t, r) && ju(e, r, t[r]);
                      if (Su) for (var r of Su(t)) Ru.call(t, r) && ju(e, r, t[r]);
                      return e;
                    })({}, this.props)),
                    Ou(n, Eu({ item: t }))),
                  )
        ...
        const Pu = (0, ia.observer)(t => {
          ...
          return (
            ...
            e.createElement(
              ...
              r.isWebhook
                ? e.createElement(Sc, { type: 'hook' }, o ? r.httpVerb : T('webhook'))
                : e.createElement(Sc, { type: r.httpVerb }, yt(r.httpVerb)),
              e.createElement(Ac, { width: 'calc(100% - 38px)' }, r.sidebarLabel, t.children),
            )
          );
        });
        var Au = Object.defineProperty,
          Iu = (Object.getOwnPropertyDescriptor, Object.getOwnPropertySymbols),
        ...
        let Lu = class extends e.Component {
          render() {
            ...
            return e.createElement(
              Rc,
              ((e, t) => {
                for (var r in t || (t = {})) Tu.call(t, r) && Du(e, r, t[r]);
                if (Iu) for (var r of Iu(t)) _u.call(t, r) && Du(e, r, t[r]);
                return e;
              })({ className: n, style: this.props.style, expanded: o }, r ? { role: 'menu' } : {}),
              t.map((t, r) =>
                e.createElement(Cu, { key: r, item: t, onActivate: this.props.onActivate }),
              ),
            );
          }
        };
        ...
        let Nu = class extends e.Component {
          ...
          render() {
            ...
            return e.createElement(
              ...
              e.createElement(Lu, { items: t.items, onActivate: this.activate, root: !0 }),
              e.createElement(
                Ic,
                null,
                e.createElement(
        ...
        const Mu = ({ open: t }) => {
          ...
          Fu = ({ size: t = 10, className: r = '', style: n }) =>
            e.createElement(
              'svg',
              {
                className: r,
...
`;
        let Vu = class extends e.Component {
          ...
          componentDidMount() {
            Qu && Qu.add(this.stickyElement),
              this.setState({ offsetTop: this.getScrollYOffset(this.context) });
          }
          componentWillUnmount() {
            Qu && Qu.remove(this.stickyElement);
          }
          getScrollYOffset(e) {
            let t;
            return (
...
`;
          ...
          render() {
            ...
            return e.createElement(
              ...
              this.state.term && this.state.noResults
                ? e.createElement(Ku, { 'data-role': 'search:results' }, T('noResultsFound'))
                : null,
            );
          }
        }
        (nd.contextType = ce),
          ((e, t, r, n) => {
            for (var o, i = rd(t, r), s = e.length - 1; s >= 0; s--)
              (o = e[s]) && (i = o(t, r, i) || i);
            i && td(t, r, i);
          })([be.bind, (0, be.debounce)(400)], nd.prototype, 'searchCallback');
                ...
                e.createElement(
                  ...
                  e.createElement(
                    ...
                    e.createElement(
                      ...
                      e.createElement(fc, { info: t.info }),
                      (!n.disableSearch &&
                        e.createElement(nd, {
                          search: o,
                          marker: i,
                        ...
                        null,
                      e.createElement(Nu, { menu: r }),
                    ),
                    e.createElement(
                      Ju,
                      { className: 'api-content' },
                      e.createElement(uc, { store: s }),
                      e.createElement(gu, { items: r.items }),
                    ),
        ...
        od.propTypes = { store: le.instanceOf(oc).isRequired };
        var id = Object.defineProperty,
          ...
          cd = (e, t, r) =>
            t in e
              ...
              : (e[t] = r),
          pd = (e, t) => {
            for (var r in t || (t = {})) ad.call(t, r) && cd(e, r, t[r]);
            if (sd) for (var r of sd(t)) ld.call(t, r) && cd(e, r, t[r]);
            return e;
          };
        const ud = function (t) {
          ...
          return e.createElement(
            ...
            e.createElement(
              xi,
              { spec: n ? pd({}, n) : void 0, specUrl: o, options: i, onLoaded: s },
              ({ loading: t, store: r }) =>
                t
                  ? a
                    ? null
