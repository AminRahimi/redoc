...
`),fi=ee.h5`
  ...
  ${te("UnderlinedHeader")};
`,yi=(0,e.createContext)(void 0),{Provider:gi,Consumer:bi}=yi;function xi(t){const{spec:r,specUrl:n,options:o,onLoaded:i,children:s}=t,[a,l]=e.useState(null),[c,p]=e.useState(null);if(c)throw c;e.useEffect((()=>{!function(){return e=this,null,t=function*(){if(r||n){l(null);try{const e=yield ye(r||n);l(e)}catch(e){throw i&&i(e),p(e),e}}},new Promise(((r,n)=>{var o=e=>{try{s(t.next(e))}catch(e){n(e)}},i=e=>{try{s(t.throw(e))}catch(e){n(e)}},s=e=>e.done?r(e.value):Promise.resolve(e.value).then(o,i);s((t=t.apply(e,null)).next())}));var e,t}()}),[r,n]);const u=e.useMemo((()=>{if(!a)return null;try{return new oc(a,n,o)}catch(e){throw i&&i(e),e}}),[a,n,o]);return e.useEffect((()=>{u&&i&&i()}),[u,i]),s({loading:!u,store:u})}function vi(){return(0,e.useContext)(yi)}const wi=e=>Y`
  ${e} {
    cursor: pointer;
    margin-left: -20px;
    padding: 0;
...
`,Is=ee.div`
  ...
  height: 20px;
  bottom: -20px;
`;class Ts extends e.Component{render(){const{open:t,title:r,children:n}=this.props;return e.createElement(Cs,null,n,t&&e.createElement(js,null,e.createElement(Ps,null,r),e.createElement(As,null),e.createElement(Is,null)))}}const _s="undefined"!=typeof document&&document.queryCommandSupported&&document.queryCommandSupported("copy");class Ds{static isSupported(){return _s}static selectElement(e){let t,r;document.body.createTextRange?(t=document.body.createTextRange(),t.moveToElementText(e),t.select()):document.createRange&&window.getSelection&&(r=window.getSelection(),t=document.createRange(),t.selectNodeContents(e),r.removeAllRanges(),r.addRange(t))}static deselect(){if(document.selection)document.selection.empty();else if(window.getSelection){const e=window.getSelection();e&&e.removeAllRanges()}}static copySelected(){let e;try{e=document.execCommand("copy")}catch(t){e=!1}return e}static copyElement(e){Ds.selectElement(e);const t=Ds.copySelected();return t&&Ds.deselect(),t}static copyCustom(e){const t=document.createElement("textarea");t.style.position="fixed",t.style.top="0",t.style.left="0",t.style.width="2em",t.style.height="2em",t.style.padding="0",t.style.border="none",t.style.outline="none",t.style.boxShadow="none",t.style.background="transparent",t.value=e,document.body.appendChild(t),t.select();const r=Ds.copySelected();return document.body.removeChild(t),r}}const Ls=t=>{const[r,n]=e.useState(!1),o=()=>{const e="string"==typeof t.data?t.data:JSON.stringify(t.data,null,2);Ds.copyCustom(e),i()},i=()=>{n(!0),setTimeout((()=>{n(!1)}),1500)};return t.children({renderCopyButton:()=>e.createElement("button",{onClick:o},e.createElement(Ts,{title:Ds.isSupported()?"Copied":"Not supported in your browser",open:r},"Copy"))})};let zs=1;function Ns(e,t){zs=1;let r="";return r+='<div class="redoc-json">',r+="<code>",r+=Qs(e,t),r+="</code>",r+="</div>",r}function Ms(e){return void 0!==e?e.toString().replace(/&/g,"&amp;").replace(/"/g,"&quot;").replace(/</g,"&lt;").replace(/>/g,"&gt;"):""}function Fs(e){return JSON.stringify(e).slice(1,-1)}function qs(e,t){return'<span class="'+t+'">'+Ms(e)+"</span>"}function Bs(e){return'<span class="token punctuation">'+e+"</span>"}function Qs(e,t){const r=typeof e;let n="";return null==e?n+=qs("null","token keyword"):e&&e.constructor===Array?(zs++,n+=function(e,t){const r=zs>t?"collapsed":"";let n=`<button class="collapser" aria-label="${zs>t+1?"expand":"collapse"}"></button>${Bs("[")}<span class="ellipsis"></span><ul class="array collapsible">`,o=!1;const i=e.length;for(let s=0;s<i;s++)o=!0,n+='<li><div class="hoverable '+r+'">',n+=Qs(e[s],t),s<i-1&&(n+=","),n+="</div></li>";return n+=`</ul>${Bs("]")}`,o||(n=Bs("[ ]")),n}(e,t),zs--):e&&e.constructor===Date?n+=qs('"'+e.toISOString()+'"',"token string"):"object"===r?(zs++,n+=function(e,t){const r=zs>t?"collapsed":"",n=Object.keys(e),o=n.length;let i=`<button class="collapser" aria-label="${zs>t+1?"expand":"collapse"}"></button>${Bs("{")}<span class="ellipsis"></span><ul class="obj collapsible">`,s=!1;for(let a=0;a<o;a++){const l=n[a];s=!0,i+='<li><div class="hoverable '+r+'">',i+='<span class="property token string">"'+Ms(l)+'"</span>: ',i+=Qs(e[l],t),a<o-1&&(i+=Bs(",")),i+="</div></li>"}return i+=`</ul>${Bs("}")}`,s||(i=Bs("{ }")),i}(e,t),zs--):"number"===r?n+=qs(e,"token number"):"string"===r?/^(http|https):\/\/[^\s]+$/.test(e)?n+=qs('"',"token string")+'<a href="'+encodeURI(e)+'">'+Ms(Fs(e))+"</a>"+qs('"',"token string"):n+=qs('"'+Fs(e)+'"',"token string"):"boolean"===r&&(n+=qs(e,"token boolean")),n}const Us=Y`
...
`;class Ca extends e.PureComponent{render(){return 0===this.props.constraints.length?null:e.createElement("span",null," ",this.props.constraints.map((t=>e.createElement(ba,{key:t,className:"sar-ConstraintItem"}," ",t," "))))}}const ja=e.memo((function({value:t,label:r,raw:n}){if(void 0===t)return null;const o=n?String(t):JSON.stringify(t);return e.createElement("div",null,e.createElement(aa,null," ",r," ")," ",e.createElement(ya,{className:"sar-ExampleValue"},o))}));function Pa(t){const r=t.schema.pattern,{hideSchemaPattern:n}=e.useContext(ce),[o,i]=e.useState(!1),s=e.useCallback((()=>i(!o)),[o]);return!r||n?null:e.createElement(e.Fragment,null,e.createElement(fa,null,o||r.length<45?r:`${r.substr(0,45)}...`),r.length>45&&e.createElement(xa,{onClick:s},o?"Hide pattern":"Show pattern"))}function Aa({schema:t}){const{hideSchemaPattern:r}=e.useContext(ce);return t&&("string"!==t.type||t.constraints.length)&&((null==t?void 0:t.pattern)&&!r||t.items||t.displayFormat||t.constraints.length)?e.createElement(Ia,null,"[ items",t.displayFormat&&e.createElement(ua,null," <",t.displayFormat," >"),e.createElement(Ca,{constraints:t.constraints}),e.createElement(Pa,{schema:t}),t.items&&e.createElement(Aa,{schema:t.items})," ]"):null}const Ia=ee(la)`
  margin: 0 5px;
  vertical-align: text-top;
`;var Ta=Object.defineProperty,_a=Object.getOwnPropertySymbols,Da=Object.prototype.hasOwnProperty,La=Object.prototype.propertyIsEnumerable,za=(e,t,r)=>t in e?Ta(e,t,{enumerable:!0,configurable:!0,writable:!0,value:r}):e[t]=r,Na=(e,t)=>{for(var r in t||(t={}))Da.call(t,r)&&za(e,r,t[r]);if(_a)for(var r of _a(t))La.call(t,r)&&za(e,r,t[r]);return e};const Ma=(0,ia.observer)((t=>{const{enumSkipQuotes:r,hideSchemaTitles:n}=e.useContext(ce),{showExamples:o,field:i,renderDiscriminatorSwitch:s}=t,{schema:a,description:l,descriptionClass:c,deprecated:p,extensions:u,in:d,const:h}=i,m="array"===a.type,f=r||"header"===d,y=e.useMemo((()=>!o||void 0===i.example&&void 0===i.examples?null:void 0!==i.examples?e.createElement($a,{field:i}):e.createElement(ja,{label:T("example")+":",value:Ge(i,i.example),raw:Boolean(i.in)})),[i,o]),g=x(a.default)?Ge(i,a.default).replace(`${i.name}=`,""):a.default;return e.createElement("div",{className:"FieldDetailsDiv"},e.createElement("div",{className:"FieldDetailsDiv__childDiv1"},e.createElement(la,null,a.typePrefix),e.createElement(ca,{className:"sar-TypeName"},a.displayType),a.displayFormat&&e.createElement(ua,null," ","<",a.displayFormat,">"," "),a.contentEncoding&&e.createElement(ua,null," ","<",a.contentEncoding,">"," "),a.contentMediaType&&e.createElement(ua,null," ","<",a.contentMediaType,">"," "),a.title&&!n&&e.createElement(pa,null," (",a.title,") "),e.createElement(Ca,{constraints:a.constraints}),e.createElement(Pa,{schema:a}),a.isCircular&&e.createElement(ma,null," ",T("recursive")," "),m&&a.items&&e.createElement(Aa,{schema:a.items})),p&&e.createElement("div",null,e.createElement($i,{type:"warning"}," ",T("deprecated")," ")),e.createElement("div",{className:"FieldDetailsDiv__childDiv2"},e.createElement(ja,{raw:f,label:T("default")+":",value:g})),e.createElement("div",{className:"FieldDetailsDiv__childDiv3"},!s&&e.createElement(ka,{isArrayType:m,values:a.enum})," ",y),e.createElement("div",{className:"FieldDetailsDiv__childDiv4"},e.createElement(Sa,{extensions:Na(Na({},u),a.extensions)})),e.createElement("div",{className:c+" FieldDetailsDiv__description"},e.createElement(Rs,{compact:!0,source:l})),e.createElement("div",{className:"FieldDetailsDiv__childDiv6"},a.externalDocs&&e.createElement(wa,{externalDocs:a.externalDocs,compact:!0}),s&&s(t)||null,h&&e.createElement(ja,{label:T("const")+":",value:h})||null))})),Fa=e.memo(Ma);var qa=Object.defineProperty,Ba=Object.defineProperties,Qa=(Object.getOwnPropertyDescriptor,Object.getOwnPropertyDescriptors),Ua=Object.getOwnPropertySymbols,Wa=Object.prototype.hasOwnProperty,Va=Object.prototype.propertyIsEnumerable,Ha=(e,t,r)=>t in e?qa(e,t,{enumerable:!0,configurable:!0,writable:!0,value:r}):e[t]=r;let Ja=class extends e.Component{constructor(){super(...arguments),this.toggle=()=>{void 0===this.props.field.expanded&&this.props.expandByDefault?this.props.field.collapse():this.props.field.toggle()},this.handleKeyPress=e=>{"Enter"===e.key&&(e.preventDefault(),this.toggle())}}render(){const{className:t="",field:r,isLast:n,expandByDefault:o}=this.props,{name:i,deprecated:s,required:a,kind:l}=r,c=!r.schema.isPrimitive&&!r.schema.isCircular,p=void 0===r.expanded?o:r.expanded,u=e.createElement(e.Fragment,null,"additionalProperties"===l&&e.createElement(ha,null,"additional property"),"patternProperties"===l&&e.createElement(ha,null,"pattern property"),a&&e.createElement(da,null,"required")),d=c?e.createElement(sa,{className:s?"deprecated ClickablePropertyNameCell":"ClickablePropertyNameCell",kind:l,title:i},e.createElement(Ti,null),e.createElement("button",{onClick:this.toggle,onKeyPress:this.handleKeyPress,"aria-label":`expand ${i}`},e.createElement("span",{className:"property-name"},i),e.createElement(Si,{direction:p?"down":"right"})),u):e.createElement(Ai,{className:s?"deprecated":void 0,kind:l,title:i},e.createElement(Ti,null),e.createElement("span",{className:"property-name"},i),u);return e.createElement(e.Fragment,null,e.createElement("tr",{className:n?"last "+t:t},d,e.createElement(Ii,{className:"PropertyDetailsCell "+r.name},e.createElement(Fa,(h=((e,t)=>{for(var r in t||(t={}))Wa.call(t,r)&&Ha(e,r,t[r]);if(Ua)for(var r of Ua(t))Va.call(t,r)&&Ha(e,r,t[r]);return e})({},this.props),Ba(h,Qa({className:"FieldDetails"})))))),p&&c&&e.createElement("tr",{key:r.name+"inner",className:"sar-tr"},e.createElement(Pi,{colSpan:2},e.createElement(_i,null,e.createElement(jl,{schema:r.schema,skipReadOnly:this.props.skipReadOnly,skipWriteOnly:this.props.skipWriteOnly,showTitle:this.props.showTitle,level:this.props.level})))));var h}};Ja=((e,t,r,n)=>{for(var o,i=t,s=e.length-1;s>=0;s--)(o=e[s])&&(i=o(i)||i);return i})([ia.observer],Ja);Object.defineProperty,Object.getOwnPropertyDescriptor;let Ya=class extends e.Component{constructor(){super(...arguments),this.changeActiveChild=e=>{void 0!==e.idx&&this.props.parent.activateOneOf(e.idx)}}sortOptions(e,t){if(0===t.length)return;const r={};t.forEach(((e,t)=>{r[e]=t})),e.sort(((e,t)=>r[e.value]>r[t.value]?1:-1))}render(){const{parent:t,enumValues:r}=this.props;if(void 0===t.oneOf)return null;const n=t.oneOf.map(((e,t)=>({value:e.title,idx:t}))),o=n[t.activeOneOf].value;return this.sortOptions(n,r),e.createElement(ls,{value:o,options:n,onChange:this.changeActiveChild,ariaLabel:"Example"})}};Ya=((e,t,r,n)=>{for(var o,i=t,s=e.length-1;s>=0;s--)(o=e[s])&&(i=o(i)||i);return i})([ia.observer],Ya);const Za=(0,ia.observer)((({schema:{fields:t=[],title:r},showTitle:n,discriminator:o,skipReadOnly:i,skipWriteOnly:s,level:a})=>{const{expandSingleSchemaField:l,showObjectSchemaExamples:c,schemaExpansionLevel:p}=e.useContext(ce),u=e.useMemo((()=>i||s?t.filter((e=>!(i&&e.schema.readOnly||s&&e.schema.writeOnly))):t),[i,s,t]),h=l&&1===u.length||p>=a;return e.createElement(Di,null,n&&e.createElement(Ci,null,r),e.createElement("tbody",null,d(u,((t,r)=>e.createElement(Ja,{key:t.name,isLast:r,field:t,expandByDefault:h,renderDiscriminatorSwitch:(null==o?void 0:o.fieldName)===t.name?()=>e.createElement(Ya,{parent:o.parentSchema,enumValues:t.schema.enum}):void 0,className:t.expanded?"expanded":void 0,showExamples:c,skipReadOnly:i,skipWriteOnly:s,showTitle:n,level:a})))))}));var Ga=Object.defineProperty,Xa=Object.defineProperties,Ka=Object.getOwnPropertyDescriptors,el=Object.getOwnPropertySymbols,tl=Object.prototype.hasOwnProperty,rl=Object.prototype.propertyIsEnumerable,nl=(e,t,r)=>t in e?Ga(e,t,{enumerable:!0,configurable:!0,writable:!0,value:r}):e[t]=r,ol=(e,t)=>{for(var r in t||(t={}))tl.call(t,r)&&nl(e,r,t[r]);if(el)for(var r of el(t))rl.call(t,r)&&nl(e,r,t[r]);return e},il=(e,t)=>Xa(e,Ka(t));const sl=ee.div`
  padding-left: ${({theme:e})=>2*e.spacing.unit}px;
`;class al extends e.PureComponent{render(){const t=this.props.schema,r=t.items,n=void 0===t.minItems&&void 0===t.maxItems?"":`(${ot(t)})`;return t.fields?e.createElement(Za,il(ol({},this.props),{level:this.props.level})):!t.displayType||r||n.length?e.createElement("div",null,e.createElement(Mi,null," Array ",n),e.createElement(sl,null,e.createElement(jl,il(ol({},this.props),{schema:r}))),e.createElement(Fi,null)):e.createElement("div",null,e.createElement(ca,null,t.displayType))}}var ll=Object.defineProperty,cl=Object.defineProperties,pl=Object.getOwnPropertyDescriptor,ul=Object.getOwnPropertyDescriptors,dl=Object.getOwnPropertySymbols,hl=Object.prototype.hasOwnProperty,ml=Object.prototype.propertyIsEnumerable,fl=(e,t,r)=>t in e?ll(e,t,{enumerable:!0,configurable:!0,writable:!0,value:r}):e[t]=r,yl=(e,t,r,n)=>{for(var o,i=n>1?void 0:n?pl(t,r):t,s=e.length-1;s>=0;s--)(o=e[s])&&(i=(n?o(t,r,i):o(i))||i);return n&&i&&ll(t,r,i),i};let gl=class extends e.Component{constructor(){super(...arguments),this.activateOneOf=()=>{this.props.schema.activateOneOf(this.props.idx)}}render(){const{idx:t,schema:r,subSchema:n}=this.props;return e.createElement(Ni,{deprecated:n.deprecated,active:t===r.activeOneOf,onClick:this.activateOneOf},n.title||n.typePrefix+n.displayType)}};gl=yl([ia.observer],gl);let bl=class extends e.Component{render(){const{schema:{oneOf:t},schema:r}=this.props;if(void 0===t)return null;const n=t[r.activeOneOf];return e.createElement("div",null,e.createElement(zi,null," ",r.oneOfType," "),e.createElement(Li,null,t.map(((t,n)=>e.createElement(gl,{key:t.pointer,schema:r,subSchema:t,idx:n})))),e.createElement("div",null,t[r.activeOneOf].deprecated&&e.createElement($i,{type:"warning"},"Deprecated")),e.createElement(Ca,{constraints:n.constraints}),e.createElement(jl,(o=((e,t)=>{for(var r in t||(t={}))hl.call(t,r)&&fl(e,r,t[r]);if(dl)for(var r of dl(t))ml.call(t,r)&&fl(e,r,t[r]);return e})({},this.props),cl(o,ul({schema:n})))));var o}};bl=yl([ia.observer],bl);const xl=(0,ia.observer)((({schema:t})=>e.createElement("div",null,e.createElement(ca,null,t.displayType),t.title&&e.createElement(pa,null," ",t.title," "),e.createElement(ma,null," ",T("recursive")," "))));var vl=Object.defineProperty,wl=Object.defineProperties,kl=(Object.getOwnPropertyDescriptor,Object.getOwnPropertyDescriptors),Ol=Object.getOwnPropertySymbols,El=Object.prototype.hasOwnProperty,Sl=Object.prototype.propertyIsEnumerable,$l=(e,t,r)=>t in e?vl(e,t,{enumerable:!0,configurable:!0,writable:!0,value:r}):e[t]=r,Rl=(e,t)=>{for(var r in t||(t={}))El.call(t,r)&&$l(e,r,t[r]);if(Ol)for(var r of Ol(t))Sl.call(t,r)&&$l(e,r,t[r]);return e},Cl=(e,t)=>wl(e,kl(t));let jl=class extends e.Component{render(){var t;const r=this.props,{schema:n}=r,o=((e,t)=>{var r={};for(var n in e)El.call(e,n)&&t.indexOf(n)<0&&(r[n]=e[n]);if(null!=e&&Ol)for(var n of Ol(e))t.indexOf(n)<0&&Sl.call(e,n)&&(r[n]=e[n]);return r})(r,["schema"]),i=(o.level||0)+1;if(!n)return e.createElement("em",null," Schema not provided ");const{type:s,oneOf:a,discriminatorProp:l,isCircular:c}=n;if(c)return e.createElement(xl,{schema:n});if(void 0!==l){if(!a||!a.length)return console.warn(`Looks like you are using discriminator wrong: you don't have any definition inherited from the ${n.title}`),null;const t=a[n.activeOneOf];return t.isCircular?e.createElement(xl,{schema:t}):e.createElement(Za,Cl(Rl({},o),{level:i,schema:t,discriminator:{fieldName:l,parentSchema:n}}))}if(void 0!==a)return e.createElement(bl,Rl({schema:n},o));const p=P(s)?s:[s];if(p.includes("object")){if(null==(t=n.fields)?void 0:t.length)return e.createElement(Za,Cl(Rl({},this.props),{level:i}))}else if(p.includes("array"))return e.createElement(al,Cl(Rl({},this.props),{level:i}));const u={schema:n,name:"",required:!1,description:n.description,externalDocs:n.externalDocs,deprecated:!1,toggle:()=>null,expanded:!1};return e.createElement("div",null,e.createElement(Fa,{field:u}))}};jl=((e,t,r,n)=>{for(var o,i=t,s=e.length-1;s>=0;s--)(o=e[s])&&(i=o(i)||i);return i})([ia.observer],jl);var Pl=Object.defineProperty,Al=Object.defineProperties,Il=Object.getOwnPropertyDescriptors,Tl=Object.getOwnPropertySymbols,_l=Object.prototype.hasOwnProperty,Dl=Object.prototype.propertyIsEnumerable,Ll=(e,t,r)=>t in e?Pl(e,t,{enumerable:!0,configurable:!0,writable:!0,value:r}):e[t]=r;class zl extends e.PureComponent{constructor(){super(...arguments),this.renderDropdown=t=>{return e.createElement(ys,(r=((e,t)=>{for(var r in t||(t={}))_l.call(t,r)&&Ll(e,r,t[r]);if(Tl)for(var r of Tl(t))Dl.call(t,r)&&Ll(e,r,t[r]);return e})({Label:ps,Dropdown:ta},t),Al(r,Il({variant:"dark"}))));var r}}static getMediaType(e,t){if(!e)return{};const r={schema:{$ref:e}};return t&&(r.examples={example:{$ref:t}}),r}get mediaModel(){const{parser:e,schemaRef:t,exampleRef:r,options:n}=this.props;return this._mediaModel||(this._mediaModel=new Hn(e,"json",!1,zl.getMediaType(t,r),n)),this._mediaModel}render(){const{showReadOnly:t=!0,showWriteOnly:r=!1,showExample:n=!0}=this.props;return e.createElement(si,null,e.createElement(ci,null,e.createElement(ii,null,e.createElement(jl,{skipWriteOnly:!r,skipReadOnly:!t,schema:this.mediaModel.schema})),n&&e.createElement(li,null,e.createElement(Nl,null,e.createElement(na,{renderDropdown:this.renderDropdown,mediaType:this.mediaModel})))))}}const Nl=ee.div`
  background: ${({theme:e})=>e.codeBlock.backgroundColor};
  & > div,
  & > pre {
    padding: ${e=>4*e.theme.spacing.unit}px;
...
`,Gl=H().a`
  cursor: pointer;
`,Xl=e.memo((function(t){const{type:r,flow:n,RequiredScopes:o}=t,i=Object.keys((null==n?void 0:n.scopes)||{});return e.createElement(e.Fragment,null,e.createElement(Vl,null,e.createElement("b",null,"Flow type: "),e.createElement("code",null,r," ")),("implicit"===r||"authorizationCode"===r)&&e.createElement(Vl,null,e.createElement("strong",null," Authorization URL: "),e.createElement("code",null,e.createElement("a",{target:"_blank",rel:"noopener noreferrer",href:n.authorizationUrl},n.authorizationUrl))),("password"===r||"clientCredentials"===r||"authorizationCode"===r)&&e.createElement(Vl,null,e.createElement("b",null," Token URL: "),e.createElement("code",null,n.tokenUrl)),n.refreshUrl&&e.createElement(Vl,null,e.createElement("strong",null," Refresh URL: "),n.refreshUrl),!!i.length&&e.createElement(e.Fragment,null,o||null,e.createElement(Vl,null,e.createElement("b",null," Scopes: ")),e.createElement(Jl,{height:"4em"},e.createElement("ul",null,i.map((t=>e.createElement("li",{key:t},e.createElement("code",null,t)," -"," ",e.createElement(Rs,{className:"redoc-markdown",inline:!0,source:n.scopes[t]||""}))))))))}));function Kl(t){const{RequiredScopes:r,scheme:n}=t;return e.createElement(xs,null,n.apiKey?e.createElement(e.Fragment,null,e.createElement(Vl,null,e.createElement("b",null,S(n.apiKey.in||"")," parameter name: "),e.createElement("code",null,n.apiKey.name)),r):n.http?e.createElement(e.Fragment,null,e.createElement(Vl,null,e.createElement("b",null,"HTTP Authorization Scheme: "),e.createElement("code",null,n.http.scheme)),e.createElement(Vl,null,"bearer"===n.http.scheme&&n.http.bearerFormat&&e.createElement(e.Fragment,null,e.createElement("b",null,"Bearer format: "),e.createElement("code",null,n.http.bearerFormat))),r):n.openId?e.createElement(e.Fragment,null,e.createElement(Vl,null,e.createElement("b",null,"Connect URL: "),e.createElement("code",null,e.createElement("a",{target:"_blank",rel:"noopener noreferrer",href:n.openId.connectUrl},n.openId.connectUrl))),r):n.flows?Object.keys(n.flows).map((t=>e.createElement(Xl,{key:t,type:t,RequiredScopes:r,flow:n.flows[t]}))):null)}const ec={oauth2:"OAuth2",apiKey:"API Key",http:"HTTP",openIdConnect:"OpenID Connect"};class tc extends e.PureComponent{render(){return this.props.securitySchemes.schemes.map((t=>e.createElement(si,{id:t.sectionId,key:t.id},e.createElement(ci,null,e.createElement(ii,null,e.createElement(hi,null,e.createElement(Oi,{to:t.sectionId}),t.displayName),e.createElement(Rs,{source:t.description||"",className:t.descriptionClass}),e.createElement(Hl,null,e.createElement(Vl,null,e.createElement("b",null,"Security Scheme Type: "),e.createElement("span",null,ec[t.type]||t.type)),e.createElement(Kl,{scheme:t})))))))}}var rc=(e,t,r)=>new Promise(((n,o)=>{var i=e=>{try{a(r.next(e))}catch(e){o(e)}},s=e=>{try{a(r.throw(e))}catch(e){o(e)}},a=e=>e.done?n(e.value):Promise.resolve(e.value).then(i,s);a((r=r.apply(e,t)).next())}));function nc(e,t){return rc(this,arguments,(function*(e,t,r={}){const n=yield ye(e||t);return new oc(n,t,r)}))}class oc{constructor(e,t,r={},n=!0){this.marker=new Wt,this.disposer=null,this.rawOptions=r,this.options=new W(r,ic),this.scroll=new ni(this.options),Ko.updateOnHistory(Qt.currentId,this.scroll),this.spec=new To(e,t,this.options),this.menu=new Ko(this.spec,this.scroll,Qt),this.options.disableSearch||(this.search=new oi,n&&this.search.indexItems(this.menu.items),this.disposer=(0,de.observe)(this.menu,"activeItemIdx",(e=>{this.updateMarkOnMenu(e.newValue)})))}static fromJS(e){const t=new oc(e.spec.data,e.spec.url,e.options,!1);return t.menu.activeItemIdx=e.menu.activeItemIdx||0,t.menu.activate(t.menu.flatItems[t.menu.activeItemIdx]),t.options.disableSearch||t.search.load(e.searchIndex),t}onDidMount(){this.menu.updateOnHistory(),this.updateMarkOnMenu(this.menu.activeItemIdx)}dispose(){this.scroll.dispose(),this.menu.dispose(),this.search&&this.search.dispose(),null!=this.disposer&&this.disposer()}toJS(){return rc(this,null,(function*(){return{menu:{activeItemIdx:this.menu.activeItemIdx},spec:{url:this.spec.parser.specUrl,data:this.spec.parser.spec},searchIndex:this.search?yield this.search.toJS():void 0,options:this.rawOptions}}))}updateMarkOnMenu(e){const t=Math.max(0,e),r=Math.min(this.menu.flatItems.length,t+5),n=[];for(let e=t;e<r;e++){const t=this.menu.getElementAt(e);t&&n.push(t)}if(-1===e&&s){const e=document.querySelector('[data-role="redoc-description"]'),t=document.querySelector('[data-role="redoc-summary"]');e&&n.push(e),t&&n.push(t)}this.marker.addOnly(n),this.marker.mark()}}const ic={allowedMdComponents:{[ut]:{component:tc,propsSelector:e=>({securitySchemes:e.spec.securitySchemes})},[dt]:{component:tc,propsSelector:e=>({securitySchemes:e.spec.securitySchemes})},[ht]:{component:zl,propsSelector:e=>({parser:e.spec.parser,options:e.options})}}},sc=ee(di)`
  margin-top: 0;
  margin-bottom: 0.5em;
...
`;function $c(e,{theme:t},r){return e>1?t.sidebar.level1Items[r]:1===e?t.sidebar.groupItems[r]:""}const Rc=ee.ul`
  margin: 0;
  padding: 0;
...
`,jc={0:Y`
  ...
  `},Pc=ee.label.attrs((e=>({className:Ec()("-depth"+e.depth,{active:e.active})})))`
  cursor: pointer;
...
`,Dc=ee(Sc)`
  margin: 0 5px 0 0;
`,Lc=ee((t=>{const{name:r,opened:n,className:o,onClick:i,httpVerb:s,deprecated:a}=t;return e.createElement(Tc,{className:o,onClick:i||void 0},e.createElement(Dc,{type:s},yt(s)),e.createElement(Si,{size:"1.5em",direction:n?"down":"right",float:"left"}),e.createElement(_c,{deprecated:a},r),a?e.createElement($i,{type:"warning"}," ",T("deprecated")," "):null)}))`
  padding: 10px;
  border-radius: 2px;
  margin-bottom: 4px;
  line-height: 1.5em;
...
`,zc=ee.div`
  ...
  margin-bottom: 5px;
  margin-top: 5px;
`;class Nc extends e.PureComponent{constructor(){super(...arguments),this.selectElement=()=>{Ds.selectElement(this.child)}}render(){const{children:t}=this.props;return e.createElement("div",{ref:e=>this.child=e,onClick:this.selectElement,onFocus:this.selectElement,tabIndex:0,role:"button"},t)}}const Mc=ee.div`
  cursor: pointer;
  position: relative;
  margin-bottom: 5px;
`,Fc=ee.span`
...
`,Bc=ee.span.attrs((e=>({className:`http-verb ${e.type}`})))`
...
`;class Vc extends e.Component{constructor(e){super(e),this.toggle=()=>{this.setState({expanded:!this.state.expanded})},this.state={expanded:!1}}render(){const{operation:t,inverted:r,hideHostname:n}=this.props,{expanded:o}=this.state;return e.createElement(ce.Consumer,null,(i=>e.createElement(Mc,null,e.createElement(qc,{onClick:this.toggle,expanded:o,inverted:r},e.createElement(Bc,{type:t.httpVerb,compact:this.props.compact},t.httpVerb),e.createElement(Fc,null,t.path),e.createElement(Si,{float:"right",color:r?"black":"white",size:"20px",direction:o?"up":"down",style:{marginRight:"-25px"}})),e.createElement(Qc,{expanded:o,"aria-hidden":!o},t.servers.map((r=>{const o=i.expandDefaultServerVariables?ct(r.url,r.variables):r.url,s=E(o);return e.createElement(Uc,{key:o},e.createElement(Rs,{source:r.description||"",className:r.descriptionClass,compact:!0}),e.createElement(Nc,null,e.createElement(Wc,null,e.createElement("span",null,n||i.hideHostname?"/"===s?"":s:o),t.path)))}))))))}}class Hc extends e.PureComponent{render(){const{place:t,parameters:r}=this.props;return r&&r.length?e.createElement("div",{key:t},e.createElement(fi,null,t," Parameters"),e.createElement(Di,null,e.createElement("tbody",null,d(r,((t,r)=>e.createElement(Ja,{key:t.name,isLast:r,field:t,showExamples:!0})))))):null}}Object.defineProperty,Object.getOwnPropertyDescriptor;let Jc=class extends e.Component{constructor(){super(...arguments),this.switchMedia=({idx:e})=>{this.props.content&&void 0!==e&&this.props.content.activate(e)}}render(){const{content:t}=this.props;if(!t||!t.mediaTypes||!t.mediaTypes.length)return null;const r=t.activeMimeIdx,n=t.mediaTypes.map(((e,t)=>({value:e.name,idx:t}))),o=({children:t})=>this.props.withLabel?e.createElement(ea,null,e.createElement(Ks,null,"Content type"),t):t;return e.createElement(e.Fragment,null,e.createElement(o,null,this.props.renderDropdown({value:n[r].value,options:n,onChange:this.switchMedia,ariaLabel:"Content type"})),this.props.children(t.active))}};Jc=((e,t,r,n)=>{for(var o,i=t,s=e.length-1;s>=0;s--)(o=e[s])&&(i=o(i)||i);return i})([ia.observer],Jc);var Yc=Object.defineProperty,Zc=Object.getOwnPropertySymbols,Gc=Object.prototype.hasOwnProperty,Xc=Object.prototype.propertyIsEnumerable,Kc=(e,t,r)=>t in e?Yc(e,t,{enumerable:!0,configurable:!0,writable:!0,value:r}):e[t]=r,ep=(e,t)=>{for(var r in t||(t={}))Gc.call(t,r)&&Kc(e,r,t[r]);if(Zc)for(var r of Zc(t))Xc.call(t,r)&&Kc(e,r,t[r]);return e};const tp=["path","query","cookie","header"];class rp extends e.PureComponent{orderParams(e){const t={};return e.forEach((e=>{var r,n,o;o=e,(r=t)[n=e.in]||(r[n]=[]),r[n].push(o)})),t}render(){const{body:t,parameters:r=[]}=this.props;if(void 0===t&&void 0===r)return null;const n=this.orderParams(r),o=r.length>0?tp:[],i=t&&t.content,s=t&&t.description,a=t&&t.required;return e.createElement(e.Fragment,null,o.map((t=>e.createElement(Hc,{key:t,place:t,parameters:n[t]}))),i&&e.createElement(op,{content:i,description:s,bodyRequired:a}))}}function np(t){var r=t,{bodyRequired:n}=r,o=((e,t)=>{var r={};for(var n in e)Gc.call(e,n)&&t.indexOf(n)<0&&(r[n]=e[n]);if(null!=e&&Zc)for(var n of Zc(e))t.indexOf(n)<0&&Xc.call(e,n)&&(r[n]=e[n]);return r})(r,["bodyRequired"]);const i="boolean"==typeof n&&!!n,s="boolean"==typeof n&&!n;return e.createElement(fi,{key:"header"},"Request Body schema: ",e.createElement(ys,ep({},o)),i&&e.createElement(sp,null,"required"),s&&e.createElement(ap,null,"optional"))}function op(t){const{content:r,description:n,bodyRequired:o}=t,{isRequestType:i}=r;return e.createElement(Jc,{content:r,renderDropdown:t=>e.createElement(np,ep({bodyRequired:o},t))},(({schema:t})=>e.createElement(e.Fragment,null,void 0!==n&&e.createElement(Rs,{source:n}),"object"===(null==t?void 0:t.type)&&e.createElement(Ca,{constraints:(null==t?void 0:t.constraints)||[]}),e.createElement(jl,{skipReadOnly:i,skipWriteOnly:!i,key:"schema",schema:t}))))}const ip="\n  text-transform: lowercase;\n  margin-left: 0;\n  line-height: 1.5em;\n",sp=ee(da)`
  ${ip}
`,ap=ee("div")`
  ${ip}
  color: ${({theme:e})=>e.colors.text.secondary};
  font-size: ${e=>e.theme.schema.labelsTextSize};
`,lp=e.memo((function({title:t,type:r,empty:n,code:o,descriptionClass:i,opened:s,className:a,onClick:l}){return e.createElement("button",{className:a,onClick:!n&&l||void 0,"aria-expanded":s,disabled:n},!n&&e.createElement(Si,{size:"1.5em",color:r,direction:s?"down":"right",float:"left"}),e.createElement(dp,null,o," "),e.createElement("div",{className:i+" ResponseTitleComponent__Markdown"},e.createElement(Rs,{compact:!0,inline:!0,source:t})))})),cp=ee(lp)`
  display: block;
  border: 0;
  width: 100%;
  text-align: left;
...
`,pp=ee.div`
  padding: 10px;
`,up=ee(fi.withComponent("caption"))`
  text-align: left;
  margin-top: 1em;
  caption-side: top;
`,dp=ee.strong`
  vertical-align: top;
`;class hp extends e.PureComponent{render(){const{headers:t}=this.props;return void 0===t||0===t.length?null:e.createElement(Di,null,e.createElement(up,null," Response Headers "),e.createElement("tbody",null,d(t,((t,r)=>e.createElement(Ja,{isLast:r,key:t.name,field:t,showExamples:!0})))))}}var mp=Object.defineProperty,fp=Object.getOwnPropertySymbols,yp=Object.prototype.hasOwnProperty,gp=Object.prototype.propertyIsEnumerable,bp=(e,t,r)=>t in e?mp(e,t,{enumerable:!0,configurable:!0,writable:!0,value:r}):e[t]=r;class xp extends e.PureComponent{constructor(){super(...arguments),this.renderDropdown=t=>e.createElement(fi,{key:"header"},"Response Schema: ",e.createElement(ys,((e,t)=>{for(var r in t||(t={}))yp.call(t,r)&&bp(e,r,t[r]);if(fp)for(var r of fp(t))gp.call(t,r)&&bp(e,r,t[r]);return e})({},t)))}render(){const{description:t,descriptionClass:r,extensions:n,headers:o,content:i}=this.props.response;return e.createElement(e.Fragment,null,e.createElement("span",{className:r+" ResponseDetails__description"},t&&e.createElement(Rs,{source:t})),e.createElement(Sa,{extensions:n}),e.createElement(hp,{headers:o}),e.createElement(Jc,{content:i,renderDropdown:this.renderDropdown},(({schema:t})=>e.createElement(e.Fragment,null,"object"===(null==t?void 0:t.type)&&e.createElement(Ca,{constraints:(null==t?void 0:t.constraints)||[]}),e.createElement(jl,{skipWriteOnly:!0,key:"schema",schema:t})))))}}const vp=(0,ia.observer)((({response:t})=>{const{extensions:r,headers:n,type:o,summary:i,description:s,descriptionClass:a,code:l,expanded:c,content:p}=t,u=e.useMemo((()=>void 0===p?[]:p.mediaTypes.filter((e=>void 0!==e.schema))),[p]),d=e.useMemo((()=>!(r&&0!==Object.keys(r).length||0!==n.length||0!==u.length||s)),[r,n,u,s]);return e.createElement("div",null,e.createElement("span",{className:"StyledResponseTitle"},e.createElement(cp,{onClick:()=>t.toggle(),type:o,empty:d,title:i||"",descriptionClass:a,code:l,opened:c})),c&&!d&&e.createElement(pp,null,e.createElement(xp,{response:t})))})),wp=ee.h3`
  font-size: 1.3em;
  padding: 0.2em 0;
  margin: 3em 0 1.1em;
  color: ${({theme:e})=>e.colors.text.primary};
  font-weight: normal;
`;class kp extends e.PureComponent{render(){const{responses:t,isCallback:r}=this.props;return t&&0!==t.length?e.createElement("div",{className:"ResponsesList"},e.createElement(wp,null,T(r?"callbackResponses":"responses")),t.map((t=>e.createElement(vp,{key:t.code,response:t})))):null}}function Op(t){const{security:r,showSecuritySchemeType:n,expanded:o}=t,i=r.schemes.length>1;return 0===r.schemes.length?e.createElement(ql,{expanded:o},"None"):e.createElement(ql,{expanded:o},i&&"(",r.schemes.map((t=>e.createElement(Fl,{key:t.id},n&&`${ec[t.type]||t.type}: `,e.createElement("i",null,t.displayName),o&&t.scopes.length?[" (",t.scopes.map((t=>e.createElement(Ml,{key:t},t))),") "]:null))),i&&") ")}const Ep=({scopes:t})=>t.length?e.createElement("div",null,e.createElement("b",null,"Required scopes: "),t.map(((t,r)=>e.createElement(e.Fragment,{key:r},e.createElement("code",null,t)," ")))):null;function Sp(t){const r=vi(),n=null==r?void 0:r.options.showSecuritySchemeType,[o,i]=(0,e.useState)(!1),{securities:s}=t;if(!(null==s?void 0:s.length)||(null==r?void 0:r.options.hideSecuritySection))return null;const a=null==r?void 0:r.spec.securitySchemes.schemes.filter((({id:e})=>s.find((t=>t.schemes.find((t=>t.id===e))))));return e.createElement(e.Fragment,null,e.createElement(Wl,{expanded:o},e.createElement(Bl,{onClick:()=>i(!o)},e.createElement(Ul,null,"Authorizations:"),e.createElement(Si,{size:"1.3em",direction:o?"down":"right"})),e.createElement(Ql,{expanded:o},s.map(((t,r)=>e.createElement(Op,{key:r,expanded:o,showSecuritySchemeType:n,security:t}))))),o&&(null==a?void 0:a.length)&&a.map(((t,r)=>e.createElement(Hl,{key:r},e.createElement("h5",null,e.createElement($p,null)," ",ec[t.type]||t.type,": ",t.id),e.createElement(Rs,{source:t.description||"",className:t.descriptionClass}),e.createElement(Kl,{key:t.id,scheme:t,RequiredScopes:e.createElement(Ep,{scopes:Rp(t.id,s)})})))))}const $p=()=>e.createElement("svg",{xmlns:"http://www.w3.org/2000/svg",viewBox:"0 0 24 24",width:"11",height:"11"},e.createElement("path",{fill:"currentColor",d:"M18 10V6A6 6 0 0 0 6 6v4H3v14h18V10h-3zM8 6c0-2.206 1.794-4 4-4s4 1.794 4 4v4H8V6zm11 16H5V12h14v10z"}));function Rp(e,t){const r=[];let n=t.length;for(;n--;){const o=t[n];let i=o.schemes.length;for(;i--;){const t=o.schemes[i];t.id===e&&Array.isArray(t.scopes)&&r.push(...t.scopes)}}return Array.from(new Set(r))}Object.defineProperty,Object.getOwnPropertyDescriptor;let Cp=class extends e.Component{render(){const{operation:t}=this.props,{description:r,externalDocs:n}=t,o=!(!r&&!n);return e.createElement(zc,null,o&&e.createElement(jp,null,void 0!==r&&e.createElement(Rs,{source:r}),n&&e.createElement(wa,{externalDocs:n})),e.createElement(Vc,{operation:this.props.operation,inverted:!0,compact:!0}),e.createElement(Sa,{extensions:t.extensions}),e.createElement(Sp,{securities:t.security}),e.createElement(rp,{parameters:t.parameters,body:t.requestBody}),e.createElement(kp,{responses:t.responses,isCallback:t.isCallback}))}};Cp=((e,t,r,n)=>{for(var o,i=t,s=e.length-1;s>=0;s--)(o=e[s])&&(i=o(i)||i);return i})([ia.observer],Cp);const jp=ee.div`
  margin-bottom: ${({theme:e})=>3*e.spacing.unit}px;
`;Object.defineProperty,Object.getOwnPropertyDescriptor;let Pp=class extends e.Component{constructor(){super(...arguments),this.toggle=()=>{this.props.callbackOperation.toggle()}}render(){const{name:t,expanded:r,httpVerb:n,deprecated:o}=this.props.callbackOperation;return e.createElement(e.Fragment,null,e.createElement(Lc,{onClick:this.toggle,name:t,opened:r,httpVerb:n,deprecated:o}),r&&e.createElement(Cp,{operation:this.props.callbackOperation}))}};Pp=((e,t,r,n)=>{for(var o,i=t,s=e.length-1;s>=0;s--)(o=e[s])&&(i=o(i)||i);return i})([ia.observer],Pp);class Ap extends e.PureComponent{render(){const{callbacks:t}=this.props;return t&&0!==t.length?e.createElement("div",null,e.createElement(Ip,null," Callbacks "),t.map((t=>t.operations.map(((r,n)=>e.createElement(Pp,{key:`${t.name}_${n}`,callbackOperation:r})))))):null}}const Ip=ee.h3`
  font-size: 1.3em;
  padding: 0.2em 0;
  margin: 3em 0 1.1em;
  color: ${({theme:e})=>e.colors.text.primary};
  font-weight: normal;
`;Object.defineProperty,Object.getOwnPropertyDescriptor;let Tp=class extends e.Component{constructor(e){super(e),this.switchItem=({idx:e})=>{this.props.items&&void 0!==e&&this.setState({activeItemIdx:e})},this.state={activeItemIdx:0}}render(){const{items:t}=this.props;if(!t||!t.length)return null;const r=({children:t})=>this.props.label?e.createElement(ea,null,e.createElement(Ks,null,this.props.label),t):t;return e.createElement(e.Fragment,null,e.createElement(r,null,this.props.renderDropdown({value:this.props.options[this.state.activeItemIdx].value,options:this.props.options,onChange:this.switchItem,ariaLabel:this.props.label||"Callback"})),this.props.children(t[this.state.activeItemIdx]))}};Tp=((e,t,r,n)=>{for(var o,i=t,s=e.length-1;s>=0;s--)(o=e[s])&&(i=o(i)||i);return i})([ia.observer],Tp);var _p=Object.defineProperty,Dp=Object.defineProperties,Lp=(Object.getOwnPropertyDescriptor,Object.getOwnPropertyDescriptors),zp=Object.getOwnPropertySymbols,Np=Object.prototype.hasOwnProperty,Mp=Object.prototype.propertyIsEnumerable,Fp=(e,t,r)=>t in e?_p(e,t,{enumerable:!0,configurable:!0,writable:!0,value:r}):e[t]=r;let qp=class extends e.Component{constructor(){super(...arguments),this.renderDropdown=t=>{return e.createElement(ys,(r=((e,t)=>{for(var r in t||(t={}))Np.call(t,r)&&Fp(e,r,t[r]);if(zp)for(var r of zp(t))Mp.call(t,r)&&Fp(e,r,t[r]);return e})({Label:Xs,Dropdown:ta},t),Dp(r,Lp({variant:"dark"}))));var r}}render(){const t=this.props.content;return void 0===t?null:e.createElement(Jc,{content:t,renderDropdown:this.renderDropdown,withLabel:!0},(t=>e.createElement(na,{key:"samples",mediaType:t,renderDropdown:this.renderDropdown})))}};qp=((e,t,r,n)=>{for(var o,i=t,s=e.length-1;s>=0;s--)(o=e[s])&&(i=o(i)||i);return i})([ia.observer],qp);class Bp extends e.Component{render(){const t=this.props.callback.codeSamples.find((e=>ho(e)));return t?e.createElement(Qp,null,e.createElement(qp,{content:t.requestBodyContent})):null}}const Qp=ee.div`
  margin-top: 15px;
`;var Up=Object.defineProperty,Wp=Object.defineProperties,Vp=(Object.getOwnPropertyDescriptor,Object.getOwnPropertyDescriptors),Hp=Object.getOwnPropertySymbols,Jp=Object.prototype.hasOwnProperty,Yp=Object.prototype.propertyIsEnumerable,Zp=(e,t,r)=>t in e?Up(e,t,{enumerable:!0,configurable:!0,writable:!0,value:r}):e[t]=r;let Gp=class extends e.Component{constructor(){super(...arguments),this.renderDropdown=t=>{return e.createElement(ys,(r=((e,t)=>{for(var r in t||(t={}))Jp.call(t,r)&&Zp(e,r,t[r]);if(Hp)for(var r of Hp(t))Yp.call(t,r)&&Zp(e,r,t[r]);return e})({Label:Xs,Dropdown:ta},t),Wp(r,Vp({variant:"dark"}))));var r}}render(){const{callbacks:t}=this.props;if(!t||0===t.length)return null;const r=t.map((e=>e.operations.map((e=>e)))).reduce(((e,t)=>e.concat(t)),[]);if(!r.some((e=>e.codeSamples.length>0)))return null;const n=r.map(((e,t)=>({value:`${e.httpVerb.toUpperCase()}: ${e.name}`,idx:t})));return e.createElement("div",null,e.createElement(mi,null," Callback payload samples "),e.createElement(Xp,null,e.createElement(Tp,{items:r,renderDropdown:this.renderDropdown,label:"Callback",options:n},(t=>e.createElement(Bp,{key:"callbackPayloadSample",callback:t,renderDropdown:this.renderDropdown})))))}};Gp.contextType=ce,Gp=((e,t,r,n)=>{for(var o,i=t,s=e.length-1;s>=0;s--)(o=e[s])&&(i=o(i)||i);return i})([ia.observer],Gp);const Xp=ee.div`
  background: ${({theme:e})=>e.codeBlock.backgroundColor};
  padding: ${e=>4*e.theme.spacing.unit}px;
`;Object.defineProperty,Object.getOwnPropertyDescriptor;let Kp=class extends e.Component{render(){const{operation:t}=this.props,r=t.codeSamples,n=r.length>0,o=1===r.length&&this.context.hideSingleRequestSampleTab;return n&&e.createElement("div",null,e.createElement(mi,null," ",T("requestSamples")," "),e.createElement(Bi,{defaultIndex:0},e.createElement(qi.TabList,{hidden:o},r.map((t=>e.createElement(qi.Tab,{key:t.lang+"_"+(t.label||"")},void 0!==t.label?t.label:t.lang)))),r.map((t=>e.createElement(qi.TabPanel,{key:t.lang+"_"+(t.label||"")},ho(t)?e.createElement("div",null,e.createElement(qp,{content:t.requestBodyContent})):e.createElement(Js,{lang:t.lang,source:t.source}))))))||null}};Kp.contextType=ce,Kp=((e,t,r,n)=>{for(var o,i=t,s=e.length-1;s>=0;s--)(o=e[s])&&(i=o(i)||i);return i})([ia.observer],Kp);Object.defineProperty,Object.getOwnPropertyDescriptor;let eu=class extends e.Component{render(){const{operation:t}=this.props,r=t.responses.filter((e=>e.content&&e.content.hasSample));return r.length>0&&e.createElement("div",null,e.createElement(mi,null," ",T("responseSamples")," "),e.createElement(Bi,{defaultIndex:0},e.createElement(qi.TabList,null,r.map((t=>e.createElement(qi.Tab,{className:"tab-"+t.type,key:t.code},t.code)))),r.map((t=>e.createElement(qi.TabPanel,{key:t.code},e.createElement("div",null,e.createElement(qp,{content:t.content})))))))||null}};eu=((e,t,r,n)=>{for(var o,i=t,s=e.length-1;s>=0;s--)(o=e[s])&&(i=o(i)||i);return i})([ia.observer],eu);var tu=Object.defineProperty,ru=Object.defineProperties,nu=Object.getOwnPropertyDescriptors,ou=Object.getOwnPropertySymbols,iu=Object.prototype.hasOwnProperty,su=Object.prototype.propertyIsEnumerable,au=(e,t,r)=>t in e?tu(e,t,{enumerable:!0,configurable:!0,writable:!0,value:r}):e[t]=r;const lu=ee.div`
  margin-bottom: ${({theme:e})=>6*e.spacing.unit}px;
`,cu=(0,ia.observer)((({operation:t})=>{const{name:r,description:n,descriptionClass:o,deprecated:i,externalDocs:s,isWebhook:a,httpVerb:l}=t,c=!(!n&&!s),{showWebhookVerb:p}=e.useContext(ce);return e.createElement(ce.Consumer,null,(u=>{return e.createElement(ci,(d=((e,t)=>{for(var r in t||(t={}))iu.call(t,r)&&au(e,r,t[r]);if(ou)for(var r of ou(t))su.call(t,r)&&au(e,r,t[r]);return e})({},{[Xo]:t.operationHash}),h={id:t.operationHash},ru(d,nu(h))),e.createElement(ii,null,e.createElement(hi,null,e.createElement(Oi,{to:t.id}),r," ",i&&e.createElement($i,{type:"warning"}," Deprecated "),a&&e.createElement($i,{type:"primary"}," ","Webhook ",p&&l&&"| "+l.toUpperCase())),u.pathInMiddlePanel&&!a&&e.createElement(Vc,{operation:t,inverted:!0}),c&&e.createElement(lu,null,void 0!==n&&e.createElement(Rs,{source:n,className:o}),s&&e.createElement(wa,{externalDocs:s})),e.createElement(Sa,{extensions:t.extensions}),e.createElement(Sp,{securities:t.security}),e.createElement(rp,{parameters:t.parameters,body:t.requestBody}),e.createElement(kp,{responses:t.responses}),e.createElement(Ap,{callbacks:t.callbacks})),e.createElement(li,null,!u.pathInMiddlePanel&&!a&&e.createElement(Vc,{operation:t}),e.createElement(Kp,{operation:t}),e.createElement(eu,{operation:t}),e.createElement(Gp,{callbacks:t.callbacks})));var d,h}))}));var pu=Object.defineProperty,uu=Object.getOwnPropertyDescriptor,du=Object.getOwnPropertySymbols,hu=Object.prototype.hasOwnProperty,mu=Object.prototype.propertyIsEnumerable,fu=(e,t,r)=>t in e?pu(e,t,{enumerable:!0,configurable:!0,writable:!0,value:r}):e[t]=r,yu=(e,t,r,n)=>{for(var o,i=n>1?void 0:n?uu(t,r):t,s=e.length-1;s>=0;s--)(o=e[s])&&(i=(n?o(t,r,i):o(i))||i);return n&&i&&pu(t,r,i),i};let gu=class extends e.Component{render(){const t=this.props.items;return 0===t.length?null:t.map((t=>e.createElement(bu,{key:t.id,item:t})))}};gu=yu([ia.observer],gu);let bu=class extends e.Component{render(){const t=this.props.item;let r;const{type:n}=t;switch(n){case"group":r=null;break;case"tag":case"section":default:r=e.createElement(vu,((e,t)=>{for(var r in t||(t={}))hu.call(t,r)&&fu(e,r,t[r]);if(du)for(var r of du(t))mu.call(t,r)&&fu(e,r,t[r]);return e})({},this.props));break;case"operation":r=e.createElement(wu,{item:t})}return e.createElement(e.Fragment,null,r&&e.createElement(si,{id:t.id,underlined:"operation"===t.type},r),t.items&&e.createElement(gu,{items:t.items}))}};bu=yu([ia.observer],bu);const xu=t=>e.createElement(ii,{compact:!0},t);let vu=class extends e.Component{render(){const{name:t,description:r,externalDocs:n,level:o}=this.props.item,i=2===o?hi:di;return e.createElement(e.Fragment,null,e.createElement(ci,null,e.createElement(ii,{compact:!1},e.createElement(i,{className:"sar-header"},e.createElement(Oi,{to:this.props.item.id}),t))),e.createElement(kc,{parentId:this.props.item.id,source:r||"",htmlWrap:xu}),n&&e.createElement(ci,null,e.createElement(ii,null,e.createElement(wa,{externalDocs:n}))))}};vu=yu([ia.observer],vu);let wu=class extends e.Component{render(){return e.createElement(cu,{operation:this.props.item})}};wu=yu([ia.observer],wu);var ku=Object.defineProperty,Ou=Object.defineProperties,Eu=(Object.getOwnPropertyDescriptor,Object.getOwnPropertyDescriptors),Su=Object.getOwnPropertySymbols,$u=Object.prototype.hasOwnProperty,Ru=Object.prototype.propertyIsEnumerable,Cu=(e,t,r)=>t in e?ku(e,t,{enumerable:!0,configurable:!0,writable:!0,value:r}):e[t]=r;let ju=class extends e.Component{constructor(){super(...arguments),this.ref=e.createRef(),this.activate=e=>{this.props.onActivate(this.props.item),e.stopPropagation()}}componentDidMount(){this.scrollIntoViewIfActive()}componentDidUpdate(){this.scrollIntoViewIfActive()}scrollIntoViewIfActive(){this.props.item.active&&this.ref.current&&c(this.ref.current)}render(){const{item:t,withoutChildren:r}=this.props;return e.createElement(Cc,{onClick:this.activate,depth:t.depth,"data-item-id":t.id,role:"menuitem"},"operation"===t.type?e.createElement(Pu,(n=((e,t)=>{for(var r in t||(t={}))$u.call(t,r)&&Cu(e,r,t[r]);if(Su)for(var r of Su(t))Ru.call(t,r)&&Cu(e,r,t[r]);return e})({},this.props),Ou(n,Eu({item:t})))):e.createElement(Pc,{depth:t.depth,active:t.active,type:t.type,ref:this.ref},e.createElement(Ac,{title:t.sidebarLabel},t.sidebarLabel,this.props.children),t.depth>0&&t.items.length>0&&e.createElement(Si,{float:"right",direction:t.expanded?"down":"right"})||null),!r&&t.items&&t.items.length>0&&e.createElement(Lu,{expanded:t.expanded,items:t.items,onActivate:this.props.onActivate}));var n}};ju=((e,t,r,n)=>{for(var o,i=t,s=e.length-1;s>=0;s--)(o=e[s])&&(i=o(i)||i);return i})([ia.observer],ju);const Pu=(0,ia.observer)((t=>{const{item:r}=t,n=e.createRef(),{showWebhookVerb:o}=e.useContext(ce);return e.useEffect((()=>{t.item.active&&n.current&&c(n.current)}),[t.item.active,n]),e.createElement(Pc,{depth:r.depth,active:r.active,deprecated:r.deprecated,ref:n},r.isWebhook?e.createElement(Sc,{type:"hook"},o?r.httpVerb:T("webhook")):e.createElement(Sc,{type:r.httpVerb},yt(r.httpVerb)),e.createElement(Ac,{width:"calc(100% - 38px)"},r.sidebarLabel,t.children))}));var Au=Object.defineProperty,Iu=(Object.getOwnPropertyDescriptor,Object.getOwnPropertySymbols),Tu=Object.prototype.hasOwnProperty,_u=Object.prototype.propertyIsEnumerable,Du=(e,t,r)=>t in e?Au(e,t,{enumerable:!0,configurable:!0,writable:!0,value:r}):e[t]=r;let Lu=class extends e.Component{render(){const{items:t,root:r,className:n}=this.props,o=null==this.props.expanded||this.props.expanded;return e.createElement(Rc,((e,t)=>{for(var r in t||(t={}))Tu.call(t,r)&&Du(e,r,t[r]);if(Iu)for(var r of Iu(t))_u.call(t,r)&&Du(e,r,t[r]);return e})({className:n,style:this.props.style,expanded:o},r?{role:"menu"}:{}),t.map(((t,r)=>e.createElement(ju,{key:r,item:t,onActivate:this.props.onActivate}))))}};function zu(){const[t,r]=(0,e.useState)(!1);return(0,e.useEffect)((()=>{r(!0)}),[]),t?e.createElement("img",{alt:"redocly logo",onError:()=>r(!1),src:"https://cdn.redoc.ly/redoc/logo-mini.svg"}):null}Lu=((e,t,r,n)=>{for(var o,i=t,s=e.length-1;s>=0;s--)(o=e[s])&&(i=o(i)||i);return i})([ia.observer],Lu);Object.defineProperty,Object.getOwnPropertyDescriptor;let Nu=class extends e.Component{constructor(){super(...arguments),this.activate=e=>{if(e&&e.active&&this.context.menuToggle)return e.expanded?e.collapse():e.expand();this.props.menu.activateAndScroll(e,!0),setTimeout((()=>{this._updateScroll&&this._updateScroll()}))},this.saveScrollUpdate=e=>{this._updateScroll=e}}render(){const t=this.props.menu;return e.createElement(is,{updateFn:this.saveScrollUpdate,className:this.props.className,options:{wheelPropagation:!1}},e.createElement(Lu,{items:t.items,onActivate:this.activate,root:!0}),e.createElement(Ic,null,e.createElement("a",{target:"_blank",rel:"noopener noreferrer",href:"https://redocly.com/redoc/"},e.createElement(zu,null),"API docs by Redocly")))}};Nu.contextType=ce,Nu=((e,t,r,n)=>{for(var o,i=t,s=e.length-1;s>=0;s--)(o=e[s])&&(i=o(i)||i);return i})([ia.observer],Nu);const Mu=({open:t})=>{const r=t?8:-4;return e.createElement(qu,null,e.createElement(Fu,{size:15,style:{transform:`translate(2px, ${r}px) rotate(180deg)`,transition:"transform 0.2s ease"}}),e.createElement(Fu,{size:15,style:{transform:`translate(2px, ${0-r}px)`,transition:"transform 0.2s ease"}}))},Fu=({size:t=10,className:r="",style:n})=>e.createElement("svg",{className:r,style:n||{},viewBox:"0 0 926.23699 573.74994",version:"1.1",x:"0px",y:"0px",width:t,height:t},e.createElement("g",{transform:"translate(904.92214,-879.1482)"},e.createElement("path",{d:"\n          m -673.67664,1221.6502 -231.2455,-231.24803 55.6165,\n          -55.627 c 30.5891,-30.59485 56.1806,-55.627 56.8701,-55.627 0.6894,\n          0 79.8637,78.60862 175.9427,174.68583 l 174.6892,174.6858 174.6892,\n          -174.6858 c 96.079,-96.07721 175.253196,-174.68583 175.942696,\n          -174.68583 0.6895,0 26.281,25.03215 56.8701,\n          55.627 l 55.6165,55.627 -231.245496,231.24803 c -127.185,127.1864\n          -231.5279,231.248 -231.873,231.248 -0.3451,0 -104.688,\n          -104.0616 -231.873,-231.248 z\n        ",fill:"currentColor"}))),qu=ee.div`
  user-select: none;
  width: 20px;
  height: 20px;
  align-self: center;
  ...
  flex-direction: column;
  color: ${e=>e.theme.colors.primary.main};
`;Object.defineProperty,Object.getOwnPropertyDescriptor;let Bu;s&&(Bu=r(322));const Qu=Bu&&Bu(),Uu=ee.div`
...
`;let Vu=class extends e.Component{constructor(){super(...arguments),this.state={offsetTop:"0px"},this.toggleNavMenu=()=>{this.props.menu.toggleSidebar()}}componentDidMount(){Qu&&Qu.add(this.stickyElement),this.setState({offsetTop:this.getScrollYOffset(this.context)})}componentWillUnmount(){Qu&&Qu.remove(this.stickyElement)}getScrollYOffset(e){let t;return t=void 0!==this.props.scrollYOffset?W.normalizeScrollYOffset(this.props.scrollYOffset)():e.scrollYOffset(),t+"px"}render(){const t=this.props.menu.sideBarOpened,r=this.state.offsetTop;return e.createElement(e.Fragment,null,e.createElement(Uu,{open:t,className:this.props.className,style:{top:r,height:`calc(100vh - ${r})`},ref:e=>{this.stickyElement=e}},this.props.children),!this.context.hideFab&&e.createElement(Wu,{onClick:this.toggleNavMenu},e.createElement(Mu,{open:t})))}};Vu.contextType=ce,Vu=((e,t,r,n)=>{for(var o,i=t,s=e.length-1;s>=0;s--)(o=e[s])&&(i=o(i)||i);return i})([ia.observer],Vu);const Hu=ee.div`
...
`,Zu=ee.div`
  padding: 5px 0;
`,Gu=ee.input.attrs((()=>({className:"search-input"})))`
...
`,ed=ee.i`
  ...
  font-style: normal;
  color: '#666';
`;var td=Object.defineProperty,rd=Object.getOwnPropertyDescriptor;class nd extends e.PureComponent{constructor(e){super(e),this.activeItemRef=null,this.clear=()=>{this.setState({results:[],noResults:!1,term:"",activeItemIdx:-1}),this.props.marker.unmark()},this.handleKeyDown=e=>{if(27===e.keyCode&&this.clear(),40===e.keyCode&&(this.setState({activeItemIdx:Math.min(this.state.activeItemIdx+1,this.state.results.length-1)}),e.preventDefault()),38===e.keyCode&&(this.setState({activeItemIdx:Math.max(0,this.state.activeItemIdx-1)}),e.preventDefault()),13===e.keyCode){const e=this.state.results[this.state.activeItemIdx];if(e){const t=this.props.getItemById(e.meta);t&&this.props.onActivate(t)}}},this.search=e=>{const{minCharacterLengthToInitSearch:t}=this.context,r=e.target.value;r.length<t?this.clearResults(r):this.setState({term:r},(()=>this.searchCallback(this.state.term)))},this.state={results:[],noResults:!1,term:"",activeItemIdx:-1}}clearResults(e){this.setState({results:[],noResults:!1,term:e}),this.props.marker.unmark()}setResults(e,t){this.setState({results:e,noResults:0===e.length}),this.props.marker.mark(t)}searchCallback(e){this.props.search.search(e).then((t=>{this.setResults(t,e)}))}render(){const{activeItemIdx:t}=this.state,r=this.state.results.filter((e=>this.props.getItemById(e.meta))).map((e=>({item:this.props.getItemById(e.meta),score:e.score}))).sort(((e,t)=>t.score-e.score));return e.createElement(Zu,{role:"search"},this.state.term&&e.createElement(ed,{onClick:this.clear},"×"),e.createElement(Xu,null),e.createElement(Gu,{value:this.state.term,onKeyDown:this.handleKeyDown,placeholder:"Search...","aria-label":"Search",type:"text",onChange:this.search}),r.length>0&&e.createElement(is,{options:{wheelPropagation:!1}},e.createElement(Ku,{"data-role":"search:results"},r.map(((r,n)=>e.createElement(ju,{item:Object.create(r.item,{active:{value:n===t}}),onActivate:this.props.onActivate,withoutChildren:!0,key:r.item.id,"data-role":"search:result"}))))),this.state.term&&this.state.noResults?e.createElement(Ku,{"data-role":"search:results"},T("noResultsFound")):null)}}nd.contextType=ce,((e,t,r,n)=>{for(var o,i=rd(t,r),s=e.length-1;s>=0;s--)(o=e[s])&&(i=o(t,r,i)||i);i&&td(t,r,i)})([be.bind,(0,be.debounce)(400)],nd.prototype,"searchCallback");class od extends e.Component{componentDidMount(){this.props.store.onDidMount()}componentWillUnmount(){this.props.store.dispose()}render(){const{store:{spec:t,menu:r,options:n,search:o,marker:i}}=this.props,s=this.props.store;return e.createElement(X,{theme:n.theme},e.createElement(gi,{value:s},e.createElement(pe,{value:n},e.createElement(Hu,{className:"redoc-wrap"},e.createElement(Vu,{menu:r,className:"menu-content"},e.createElement(fc,{info:t.info}),!n.disableSearch&&e.createElement(nd,{search:o,marker:i,getItemById:r.getItemById,onActivate:r.activateAndScroll})||null,e.createElement(Nu,{menu:r})),e.createElement(Ju,{className:"api-content"},e.createElement(uc,{store:s}),e.createElement(gu,{items:r.items})),e.createElement(Yu,null)))))}}od.propTypes={store:le.instanceOf(oc).isRequired};var id=Object.defineProperty,sd=Object.getOwnPropertySymbols,ad=Object.prototype.hasOwnProperty,ld=Object.prototype.propertyIsEnumerable,cd=(e,t,r)=>t in e?id(e,t,{enumerable:!0,configurable:!0,writable:!0,value:r}):e[t]=r,pd=(e,t)=>{for(var r in t||(t={}))ad.call(t,r)&&cd(e,r,t[r]);if(sd)for(var r of sd(t))ld.call(t,r)&&cd(e,r,t[r]);return e};const ud=function(t){const{spec:n,specUrl:o,options:i={},onLoaded:s}=t,a=Q(i.hideLoading,!1),l=new W(i);if(void 0!==l.nonce)try{r.nc=l.nonce}catch(e){}return e.createElement(ne,null,e.createElement(xi,{spec:n?pd({},n):void 0,specUrl:o,options:i,onLoaded:s},(({loading:t,store:r})=>t?a?null:e.createElement(ae,{color:l.theme.colors.primary.main}):e.createElement(od,{store:r}))))}}(),n}()}));
